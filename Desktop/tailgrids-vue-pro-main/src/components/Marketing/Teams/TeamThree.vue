...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-03/image-01.jpg',
    name: 'Jackie Sanders',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-03/image-02.jpg',
    name: 'Andrieo Gloree',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-03/image-03.jpg',
    name: 'Adveen Desuza',
    ...
    <div class="container mx-auto">
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <template v-for="(item, index) in teamItems" :key="index">
          <div class="w-full px-4 max-w-[270px]">
            <div
              class="group border-stroke dark:border-dark-3 relative mb-10 overflow-hidden rounded-lg border bg-white dark:bg-dark-2 p-8"
            >
              ...
              <div>
                <h4 class="text-dark dark:text-white text-lg font-medium">
                  {{ item.name }}
                </h4>
                <h6
                  class="text-body-color dark:text-dark-6 mb-[10px] leading-loose text-[10px] font-medium uppercase"
                >
                  {{ item.profession }}
                </h6>
                <p class="max-w-[185px] text-body-color dark:text-dark-6 mb-8 text-xs">
                  {{ item.details }}
                </p>
                <div class="flex items-center gap-5">
                  <a :href="item.facebookLink" class="hover:text-primary text-dark-8">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                  ...
                  <a :href="item.twitterLink" class="hover:text-primary text-dark-8">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
                  ...
                  <a :href="item.instagramLink" class="hover:text-primary text-dark-8">
                    <svg
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
