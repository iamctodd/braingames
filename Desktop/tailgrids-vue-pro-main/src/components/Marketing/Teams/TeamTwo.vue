...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-02/image-01.png',
    name: 'Adveen Desuza',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-02/image-02.png',
    name: 'Jezmin uniya',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-02/image-03.png',
    name: 'Andrieo Gloree',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-02/image-04.png',
    name: 'Jackie Sanders',
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="mb-10">
              <div class="h-[170px] relative z-10 mx-auto mb-6 w-[170px] rounded-full">
                <img :src="item.image" alt="image" class="w-full rounded-full" />
              ...
              <div class="text-center">
                <h4 class="text-dark dark:text-white mb-1 text-lg font-medium">
                  {{ item.name }}
                </h4>
                <p class="text-body-color dark:text-dark-6 mb-5 text-xs font-medium">
                  {{ item.profession }}
                </p>
                <div class="flex items-center gap-5 justify-center">
                  <a :href="item.facebookLink" class="text-dark-8 hover:text-primary flex">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                  ...
                  <a :href="item.twitterLink" class="text-dark-8 hover:text-primary flex">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                  ...
                  <a :href="item.instagramLink" class="text-dark-8 hover:text-primary flex">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
