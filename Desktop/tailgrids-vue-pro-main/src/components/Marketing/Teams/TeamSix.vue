...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-06/image-01.jpg',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-06/image-02.jpg',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-06/image-03.jpg',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-06/image-04.jpg',
    name: 'Naimur Rahman',
...
<template>
  <!-- ====== Team Section Start -->
  <section class="overflow-hidden bg-dark pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]">
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[510px] text-center">
            <span class="mb-2 block text-lg font-semibold text-white"> Our Team Members </span>
