...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/image-07/image-01.png',
...
<template>
  <!-- ====== Team Section Start -->
  <section class="bg-tg-bg dark:bg-dark overflow-hidden pt-20 pb-20 lg:pt-[120px] lg:pb-[120px]">
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-[70px]">
            <span class="text-primary mb-2 block text-lg font-semibold"> Our Creative Team </span>
            <h2
              class="mb-3 text-3xl leading-[1.2] font-bold text-dark dark:text-white sm:text-4xl md:text-[40px]"
            >
              Meet Our Team
            </h2>
        ...
        <template v-for="(item, index) in teamItems" :key="index">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="group mb-8">
              <div
                class="shadow-team-2 relative z-20 mx-auto h-[130px] w-[130px] overflow-hidden rounded-full border-[10px] border-white dark:border-dark-3 bg-white dark:bg-dark-3"
              >
                <img :src="item.image" alt="image" class="w-full" />
              </div>

              <div
                class="bg-primary shadow-team-3 relative z-10 -mt-16 overflow-hidden rounded-lg px-8 pb-8 pt-24 text-center lg:px-5 xl:px-9"
              >
                <h3 class="mb-1 text-lg font-semibold text-white">
                  {{ item.name }}
                </h3>
                <p class="mb-5 text-sm text-[#D6DDF6]">
                  {{ item.profession }}
                </p>
                <p class="mb-5 text-sm text-[#D6DDF6]">
                  {{ item.details }}
                ...
                <div class="flex items-center justify-center gap-[14px]">
                  <a
                    ...
                    class="hover:text-primary flex h-8 w-8 items-center justify-center rounded-full bg-transparent text-white transition-all hover:bg-white"
                  >
                    <svg
                      width="16"
                      height="16"
                ...
                <div>
                  <span
                    class="absolute top-0 left-0 -z-10 opacity-0 transition-all group-hover:opacity-100"
                  >
                    <svg
                      width="276"
                      height="230"
                  ...
                  <span
                    class="absolute bottom-0 right-0 -z-10 opacity-0 transition-all group-hover:opacity-100"
                  >
                    <svg
                      width="276"
                      height="218"
