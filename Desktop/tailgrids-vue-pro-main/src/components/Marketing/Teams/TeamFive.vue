...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-05/image-01.jpg',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-05/image-02.jpg',
    name: 'Stuard Ferrel',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-05/image-03.jpg',
    name: 'Eva Hudson',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-05/image-04.jpg',
...
<template>
  <!-- ====== Team Section Start -->
  <section class="overflow-hidden pt-20 pb-20 lg:pt-[120px] lg:pb-[120px] dark:bg-dark">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[510px] text-center">
            <span class="block mb-2 text-lg font-semibold text-primary"> Our Team </span>
            <h2
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="w-full px-4 xl:w-10/12 2xl:w-9/12">
          <div
            class="relative z-10 flex flex-wrap rounded-[10px] bg-white dark:bg-dark-2 px-6 pt-10 shadow-team"
          >
            ...
            <span class="absolute -left-12 -top-12 z-[-1]">
              ...
              >
                ...
                <g mask="url(#mask0_924_7197)">
                  <path d="M25.1839 111.911L139.426 45.9539" stroke="#3758F9" stroke-width="3" />
                  <path d="M28.6839 117.973L142.926 52.0154" stroke="#3758F9" stroke-width="3" />
                  <path d="M32.1839 124.035L146.426 58.0779" stroke="#3758F9" stroke-width="3" />
                  <path d="M35.6839 130.098L149.926 64.1404" stroke="#3758F9" stroke-width="3" />
                  <path d="M39.1839 136.159L153.426 70.2019" stroke="#3758F9" stroke-width="3" />
                  <path d="M42.6839 142.222L156.926 76.2644" stroke="#3758F9" stroke-width="3" />
                  <path d="M18.1839 99.7864L132.426 33.8289" stroke="#3758F9" stroke-width="3" />
                  <path d="M21.6839 105.849L135.926 39.8914" stroke="#3758F9" stroke-width="3" />
                  <path d="M11.1839 87.6624L125.426 21.7049" stroke="#3758F9" stroke-width="3" />
                  <path d="M14.6839 93.7249L128.926 27.7674" stroke="#3758F9" stroke-width="3" />
                  <path d="M4.18392 75.5384L118.426 9.58085" stroke="#3758F9" stroke-width="3" />
                  <path d="M7.68197 81.5999L121.924 15.6424" stroke="#3758F9" stroke-width="3" />
                  <path d="M-2.72461 63.5752L111.517 -2.38234" stroke="#3758F9" stroke-width="3" />
                  <path d="M0.681966 69.4759L114.924 3.51835" stroke="#3758F9" stroke-width="3" />
                  <path d="M-6.2832 57.4092L107.959 -8.54836" stroke="#3758F9" stroke-width="3" />
                </g>
              </svg>
            </span>
