      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[510px] text-center">
            <span class="text-primary mb-2 block text-lg font-semibold"> Our Team Members </span>
            <h2
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <template v-for="(item, index) in teamItems" :key="index">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div
              class="group shadow-1 dark:shadow-box-dark mb-8 rounded-[5px] bg-white dark:bg-dark-2 px-5 pt-12 pb-10"
            >
              <div class="relative z-10 mx-auto mb-5 h-[120px] w-[120px]">
                <img :src="item.image" alt="image" class="h-[120px] w-[120px] rounded-full" />

                <span
                  class="bg-secondary absolute bottom-0 left-0 -z-10 h-10 w-10 rounded-full opacity-0 transition-all group-hover:opacity-100"
                ></span>
                <span
                  class="absolute top-0 right-0 -z-10 opacity-0 transition-all group-hover:opacity-100"
                >
                  <svg
                    width="55"
                    height="53"
