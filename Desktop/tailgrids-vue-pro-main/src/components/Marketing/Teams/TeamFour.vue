...
const teamItems = ref([
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-04/image-01.jpg',
    name: 'Jackie Sanders',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-04/image-02.jpg',
    name: 'Andrieo Gloree',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-04/image-03.jpg',
    name: 'Adveen Desuza',
  ...
  {
    image: 'https://cdn.tailgrids.com/1.0/assets/images/team/team-04/image-04.jpg',
    name: 'Mario Donale',
    profession: 'DIGITAL MARKETER',
    details: 'There are many variations of passages of Lorem Ipsum available, but the majority.',
    facebookLink: '/#',
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <template v-for="(item, index) in teamItems" :key="index">
          <div class="w-full px-4 lg:w-1/2">
            <div class="mx-auto mb-10 max-w-[320px] items-stretch sm:flex sm:max-w-full">
              <div class="mr-9 w-full overflow-hidden rounded-[5px] sm:max-w-[200px]">
                <img :src="item.image" alt="image" class="w-full" />
              </div>

              <div class="relative flex w-full items-center">
                <div class="py-4">
                  <h4 class="text-dark dark:text-white mb-1 text-lg font-semibold">
                    {{ item.name }}
                  </h4>
                  <h6
                    class="text-body-color dark:text-dark-6 mb-[14px] leading-[1.66] text-xs font-medium uppercase"
                  >
                    {{ item.profession }}
                  </h6>
                  <p class="max-w-[290px] text-body-color dark:text-dark-6 mb-5 text-sm">
                    {{ item.details }}
                  </p>
