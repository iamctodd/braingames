...
<template>
        ...
        <div class="flex w-full items-center justify-between px-4">
          <div>
            ...
            <nav
              :class="{ hidden: !open }"
              id="navbarCollapse"
              class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white dark:bg-dark-2 py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none xl:ml-10 lg:dark:bg-transparent"
            >
  ...
  <!-- ====== Hero Section Start -->
  <div
    class="relative z-10 bg-[#090E34] pt-[120px] pb-[120px] md:pt-[150px] lg:pt-[180px] lg:pb-[150px]"
  >
      ...
      <div class="-mx-4 flex flex-wrap items-center">
        <div class="w-full px-4">
          <div class="mx-auto max-w-[550px] text-center">
            <span class="mb-3 block text-lg font-medium text-white"> We Are Creative </span>
            <h1 class="mb-2 text-[60px] font-bold leading-[1.10] text-white md:text-[100px]">
              Branding
            </h1>
            <h2 class="mb-6 text-[30px] leading-[1.208] font-bold text-white md:text-[40px]">
              Digital Agency
            </h2>
            <p class="mx-auto mb-9 max-w-[460px] text-base font-medium text-white">
