...
<template>
  ...
  <header class="absolute left-0 top-0 z-50 w-full bg-white dark:bg-dark lg:overflow-hidden">
    <div class="container">
      <div class="relative flex items-center justify-between -mx-4">
        <div class="relative z-10 w-60 max-w-full px-4 py-3">
          ...
          <span
            class="absolute right-0 top-1/2 z-[-1] h-full w-[1000%] -translate-y-1/2 bg-primary lg:h-[125%]"
          ></span>
        </div>
        <div class="flex w-full items-center justify-between px-4">
                ...
                <template v-for="(item, index) in navLinkItems" :key="index">
                  <li>
                    <a
                      v-if="item.href"
                      :href="item.href"
                      class="flex border-transparent py-2 text-base font-medium text-dark dark:text-white hover:border-primary hover:text-primary lg:ml-10 lg:inline-flex lg:border-t-2 lg:py-7"
                    >
                      {{ item.text }}
                    </a>
                  </li>
          ...
          <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
            <div class="flex items-center">
              <div
                class="flex h-11 min-w-[44px] items-center justify-center rounded-full bg-primary text-white"
              >
              ...
              <div class="ml-4 w-full whitespace-nowrap">
                <span class="block text-sm font-medium dark:text-white">Call Us</span>
                <h6 class="text-base font-semibold text-dark dark:text-white">360-779-2228</h6>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="max-w-[570px] bg-white dark:bg-dark-2 py-10 px-8 sm:p-12 md:p-[60px]">
              <span class="mb-3 block text-base font-medium text-primary">
                Delivering beautiful digital products
              </span>
              <h1
                class="mb-3 text-3xl font-bold leading-[1.208] text-dark dark:text-white md:text-[40px] xl:text-5xl"
              >
              ...
              <div class="flex flex-wrap gap-3">
                <a
                  ...
                  class="bg-primary py-3 px-7 text-base font-medium text-white transition hover:bg-blue-dark"
                >
                  Discover More
                </a>
                <a
                  href="javascript:void(0)"
                  class="inline-flex items-center py-3 px-6 text-base font-medium bg-white dark:bg-dark-2 shadow-1 dark:shadow-none text-dark dark:text-white hover:text-primary"
                >
                  Explore Services
                  <span class="ml-2">
                    <svg
