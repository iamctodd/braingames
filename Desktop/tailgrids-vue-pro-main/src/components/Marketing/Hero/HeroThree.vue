...
<template>
        ...
        <div class="flex w-full items-center justify-between px-4">
          <div>
            ...
            <nav
              :class="{ hidden: !open }"
              id="navbarCollapse"
              class="absolute right-4 top-full z-10 w-full max-w-[250px] rounded-lg bg-white dark:bg-dark-2 py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none xl:ml-11 lg:dark:bg-transparent"
            >
  ...
  <!-- ====== Hero Section Start -->
  <div
    class="relative overflow-hidden z-10 bg-white dark:bg-dark pt-[120px] pb-[110px] md:pt-[150px] lg:pt-[180px]"
  >
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 lg:w-5/12">
          <div class="hero-content">
            <span
              class="mb-4 inline-block rounded-[30px] rounded-tl-[20px] rounded-bl-none border border-stroke dark:border-dark-3 py-2 px-[22px] font-semibold text-xs uppercase text-body-color dark:text-dark-6"
            >
              HELLO MY NAME IS
            </span>
            <h1
              class="mb-3 text-4xl font-bold leading-[1.208] text-dark dark:text-white sm:text-[42px] lg:text-[30px] xl:text-5xl"
            >
              Devid Millar
            </h1>
            <p class="mb-5 flex items-center text-base font-medium">
              <span class="text-dark dark:text-white"> Professional: </span>
              <span class="pl-3 text-body-color dark:text-dark-6"> Graphics Designer </span>
            </p>
            ...
            <ul class="flex flex-wrap items-center">
              <li>
                <a
                  href="javascript:void(0)"
                  class="inline-flex items-center justify-center rounded-md bg-primary py-3 px-7 text-center text-base font-medium text-white hover:bg-blue-dark"
                >
                  Hire Me Now!
                </a>
              </li>
            ...
            <div class="pt-[50px]">
              <h6
                class="mb-5 flex items-center text-xs font-medium text-body-color dark:text-dark-6"
              >
                Contact With Me
                <span class="ml-3 inline-block h-px w-8 bg-body-color dark:bg-dark-6"></span>
              </h6>
              <ul class="flex flex-wrap items-center gap-7">
                ...
                <li>
                  <a href="javascript:void(0)" class="text-body-color hover:text-primary">
                    ...
                    >
                      <path
                        d="M8.90245 12.1938C10.7363 12.1938 12.2229 10.7072 12.2229 8.8734C12.2229 7.03958 10.7363 5.55298 8.90245 5.55298C7.06863 5.55298 5.58203 7.03958 5.58203 8.8734C5.58203 10.7072 7.06863 12.1938 8.90245 12.1938Z"
                      />
                      <path
                      ...
                      />
                      <path
                        d="M13.7398 3.03418C13.3677 3.03418 13.0529 3.34905 13.0529 3.72116C13.0529 4.09328 13.3677 4.40815 13.7398 4.40815C14.112 4.40815 14.4268 4.09328 14.4268 3.72116C14.4268 3.34905 14.1406 3.03418 13.7398 3.03418Z"
                      />
                    </svg>
                  </a>
                </li>
        ...
        <div class="w-full px-4 lg:w-6/12">
          <div class="lg:ml-auto lg:text-right">
            <div
              class="absolute right-0 top-1/2 z-[-1] hidden w-1/2 -translate-y-1/2 lg:block lg:w-full"
            >
              <img
