        ...
        <div class="flex w-full items-center justify-between px-4">
          ...
          <div class="justify-end hidden pr-16 sm:flex lg:pr-0">
            <a
              ...
              class="py-3 text-base font-medium duration-300 bg-transparent rounded-md px-7 text-primary hover:bg-primary/5"
            >
              Sign In
            </a>
          </div>
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="w-full px-4">
          <div class="hero-content mx-auto max-w-[666px] text-center">
            <span class="block mb-5 text-base font-semibold text-primary sm:text-lg md:text-xl">
              Built With TailGrids Components
            </span>
            <h1
              class="mb-5 text-3xl font-bold capitalize !leading-[1.208] text-dark dark:text-white sm:text-[42px] xl:text-5xl"
            >
              Ready for Any Websites Crafted by TailGrids
            </h1>
            <p class="text-base font-medium mb-9 text-body-color dark:text-dark-6 md:text-lg">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at egestas tortor.
              Morbi sed odio id purus pellentesque iaculis.
            </p>
            <ul class="flex flex-wrap items-center justify-center gap-4">
              <li>
                <a
                  href="javascript:void(0)"
                  class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md bg-primary px-7 hover:bg-blue-dark"
                >
                  Know More
                </a>
              </li>
              <li>
                <a
                  href="javascript:void(0)"
                  class="inline-flex items-center justify-center py-3 text-base font-medium text-center transition border rounded-md border-primary dark:border-white px-7 text-primary dark:text-white hover:border-primary hover:bg-primary hover:text-white"
                >
                  Contact Us
                </a>
              </li>
