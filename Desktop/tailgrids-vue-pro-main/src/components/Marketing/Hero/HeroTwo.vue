...
<template>
        ...
        <div class="flex w-full items-center justify-between px-4">
          <div>
            ...
            <nav
              :class="{ hidden: !open }"
              id="navbarCollapse"
              class="absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-dark-2 py-5 px-6 shadow lg:static lg:block lg:w-full lg:max-w-full lg:bg-transparent lg:shadow-none xl:ml-11 lg:dark:bg-transparent"
            >
  ...
  <!-- ====== Hero Section Start -->
  <div class="relative bg-[#090E34] dark:bg-dark pt-[120px] pb-[110px] md:pt-[150px] lg:pt-[180px]">
