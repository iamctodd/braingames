...
<template>
  ...
  <div
    ...
    style="
      background-image: url('https://cdn.tailgrids.com/2.0/image/marketing/images/hero/hero-bg-13.jpg');
    "
  >
      ...
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <div class="mb-16 max-w-[500px] lg:mb-0">
            <span class="block mb-5 text-base font-semibold text-white sm:text-lg md:text-xl">
              Digital Marketing
            </span>
            <h1
            ...
            <p class="text-base text-white mb-9">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin posuere arcu sit amet
              ligula feugiat eleifend.
            </p>
        ...
        <div class="w-full px-4 lg:w-1/2">
          ...
          >
            ...
            <p class="mb-8 text-base font-medium text-body-color dark:text-dark-6">
