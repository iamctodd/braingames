      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mb-[60px] max-w-[510px] lg:mb-[70px]">
            <span class="text-primary mb-2 block text-lg font-semibold"> What we Serve </span>
            <h2
        ...
        <template v-for="(item, index) in featuresItems" :key="index">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="group mb-12">
              ...
              <h4 class="text-dark dark:text-white mb-3 text-xl font-bold">
                {{ item.title }}
              </h4>
              <p class="text-body-color dark:text-dark-6 mb-9">
                {{ item.details }}
              </p>
              <a
                :href="item.button.link"
                class="text-dark dark:text-white hover:text-primary text-base font-medium"
              >
                {{ item.button.text }}
              </a>
            </div>
