...
<template>
  <!-- ====== About Section Start -->
  <section
    class="relative z-10 overflow-hidden bg-white dark:bg-dark py-20 lg:py-[110px]"
  >
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <div class="bg-primary relative z-10 mb-12 py-12 px-5 sm:px-12 lg:mb-0 2xl:p-[70px]">
            <h2 class="mb-6 text-xl font-bold text-white uppercase">OUR VISION</h2>
            <p class="mb-6 text-base leading-relaxed text-gray-4">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eget feugiat nisi. Nam
              eu odio iaculis neque vestibu pharetra eu eget enim. Vestibulum eu risus porttitor,
              commodo magna ut, eleifend ex.
            </p>
            <p class="mb-8 text-base leading-relaxed text-gray-4">
              Curabitur ut rutrum tellus. Nullam ornare nunc non felis viverra tempus.
            </p>
            <div class="items-end justify-between md:flex lg:block xl:flex">
              <div class="">
                <div class="flex items-center">
                  <span class="text-5xl font-extrabold text-white"> 05 </span>
                  <p class="pl-3 text-base">
                    <span class="block font-semibold text-white"> We have </span>
                    <span class="text-gray-4"> Years of experience </span>
                  </p>
                </div>
              </div>
              <div class="pt-4 md:text-right lg:text-left xl:text-right">
                <a
        ...
        <div class="w-full px-4 lg:w-1/2">
          <div class="flex items-center justify-center w-full h-full">
            <img
              src="https://cdn.tailgrids.com/2.0/image/marketing/images/about/about-06/video-thumbnail.jpg"
              alt="image"
              class="top-0 left-0 z-[-1] h-full w-full"
            />
            <a
              href="javascript:void(0)"
              @click="setModalOpen(true)"
              class="absolute z-40 flex h-20 w-20 items-center justify-center rounded-full bg-white md:h-[100px] md:w-[100px]"
            >
              <span
                class="absolute top-0 right-0 z-[-1] h-full w-full animate-ping rounded-full bg-white bg-opacity-25 delay-300 duration-1000"
              ></span>
              <svg width="23" height="27" viewBox="0 0 23 27" class="fill-current text-primary">
                <path
    ...
    @click="setModalOpen(false)"
      ...
      class="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-screen bg-black bg-opacity-80"
    >
      <div ref="modalContainer" @click.stop class="mx-auto w-full max-w-[550px] bg-white">
        <iframe
      ...
      <button
        @click="setModalOpen(false)"
        class="absolute top-0 right-0 flex items-center justify-center w-20 h-20 bg-black cursor-pointer text-body-color hover:bg-dark"
      >
