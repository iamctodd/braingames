<template>
  <!-- ====== About Section Start -->
  <section class="overflow-hidden py-20 bg-white dark:bg-dark lg:py-[120px]">
    <div class="container mx-auto">
      <div class="flex flex-wrap items-end justify-between -mx-4">
        <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
          <div class="mb-10 lg:mb-0">
            <span class="block mb-2 text-lg font-semibold uppercase text-primary sm:text-xl">
              ABOUT ME
            </span>
            <h2
              class="mb-5 max-w-[400px] text-3xl font-bold leading-tight text-dark dark:text-white sm:text-4xl sm:leading-tight md:text-[40px]/[48px]"
            >
              Better design, better experience
            </h2>
            <p class="text-base text-body-color dark:text-dark-6 mb-9">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque dui ligula, malesuada
              vel convallis in, tincidunt ut mi Vestibulum sit amet.
            </p>
            <div class="flex flex-wrap -mx-4">
              <div class="w-full px-4 md:w-1/2 lg:w-full xl:w-7/12">
                <div
                  class="inline-flex items-center p-5 mb-8 bg-white rounded-lg dark:bg-dark-2 shadow-[0px_1px_4px_0px_rgba(0,0,0,0.12)] xl:mb-0"
                >
                  <div
                    class="bg-primary/5 dark:bg-white/5 text-primary mr-4 flex h-11 w-full max-w-[44px] items-center justify-center rounded-lg"
                  >
                    <svg
                      width="22"
                      height="22"
                  ...
                  <div class="w-full">
                    <span class="text-sm font-medium text-body-color dark:text-dark-6">
                      Email address
                    </span>
                    <a href="javascript:void(0)" class="text-base font-semibold text-primary">
                      contact@tailgrids.com
                    </a>
                  </div>
                </div>
              </div>
              <div class="w-full px-4 md:w-1/2 lg:w-full xl:w-5/12">
                <div class="mb-8 xl:mb-0">
                  <h5 class="mb-3 text-base font-medium text-body-color dark:text-dark-6">
                    Follow Me On:
                  </h5>
                  <div class="flex items-center space-x-3">
                    <a
                      href="javascript:void(0)"
                      class="flex items-center justify-center border rounded-md border-stroke dark:border-dark-3 text-body-color dark:text-dark-6 hover:border-primary hover:bg-primary h-9 w-9 hover:text-white"
                    >
                      <svg width="7" height="14" viewBox="0 0 7 14" class="fill-current">
                        <path
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="space-y-8">
            <div>
              <h5 class="mb-5 text-lg font-semibold text-dark dark:text-white">Design</h5>
              <div class="relative w-full h-2 rounded-2xl bg-stroke dark:bg-dark-3">
                <div class="bg-primary absolute top-0 left-0 h-full w-[80%] rounded-2xl"></div>
              </div>
            </div>
            <div>
              <h5 class="mb-5 text-lg font-semibold text-dark dark:text-white">Branding</h5>
              <div class="relative w-full h-2 rounded-2xl bg-stroke dark:bg-dark-3">
                <div class="bg-primary absolute top-0 left-0 h-full w-[70%] rounded-2xl"></div>
              </div>
            </div>
            <div>
              <h5 class="mb-5 text-lg font-semibold text-dark dark:text-white">Web Design</h5>
              <div class="relative w-full h-2 rounded-2xl bg-stroke dark:bg-dark-3">
                <div class="bg-primary absolute top-0 left-0 h-full w-[92%] rounded-2xl"></div>
              </div>
            </div>
          </div>
        </div>
