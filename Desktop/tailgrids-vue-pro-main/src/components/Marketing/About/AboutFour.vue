<template>
  <!-- ====== About Section Start -->
  <div class="relative pt-[150px] pb-[110px] lg:pt-[170px] bg-white dark:bg-dark">
    <div class="container mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <div class="mb-12 max-w-[540px] lg:mb-0">
            <h2
              class="mb-5 text-3xl font-bold leading-tight text-dark dark:text-white sm:text-[40px]/[48px]"
            >
              Smart solution for starting your business
            </h2>
            <p class="mb-10 text-base leading-relaxed dark:text-dark-6 text-body-color">
              Proin gravida nibh vel velit auctor aliquet. aks Aenean sollicitudin, lorem quis
              bibendum auctor, nisi elit consequat ipsum, nec sagittis sem.consequat ipsum, nec
              sagittis sem nibh id elit.Donec vestibulum justo a diam ultricies. pel lentesque.
            </p>
            <h3 class="mb-8 text-2xl font-bold text-dark dark:text-white">Marketing solutions</h3>
            <ul class="pb-6 list-disc list-inside marker:text-primary">
              <li class="mb-4 text-base text-body-color dark:text-dark-6">
