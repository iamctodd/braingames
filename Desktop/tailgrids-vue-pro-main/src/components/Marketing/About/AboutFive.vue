      ...
      <div class="flex flex-wrap items-center justify-between -mx-4">
        ...
        <div class="w-full px-4 lg:w-1/2 2xl:w-5/12">
          <div class="sm:mt-10 lg:mt-0">
            ...
            <h3 class="mb-4 text-lg font-bold text-dark dark:text-white">Company Benefits</h3>
            ...
            <h3 class="mb-4 text-lg font-bold text-dark dark:text-white">Competitive Salary</h3>
