...
<template>
  <section class="relative z-10 overflow-hidden bg-primary">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <div class="max-w-[490px] py-[100px] lg:py-[140px]">
            <span class="block mb-3 text-base font-medium text-white"> Watch Our Intro Video </span>
            <h2
              class="mb-5 text-3xl !leading-[1.2] font-bold text-white sm:text-4xl md:text-[40px]"
            >
              Innovative solutions to boost your projects
            </h2>
            <p class="text-base text-white mb-9">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin at quam fringilla,
              scelerisque nisl in, accumsan diam. Quisque sollicitudin risus eu tortor euismod
              imperdiet.
            </p>
            <a
    ...
    <div>
      <div class="top-0 right-0 z-10 w-full h-full lg:absolute lg:w-1/2">
        <div ref="videoContainer" class="flex items-center justify-center w-full h-full">
          <img
            src="https://cdn.tailgrids.com/2.0/image/marketing/images/videos/image-01.jpg"
            alt="image"
    ...
    >
      ...
      >
        <iframe class="h-[320px] w-full" src="https://www.youtube.com/embed/LXb3EKWsInQ?autoplay=1&mute=1"> </iframe>
      </div>
      <button
        @click="closeVideo"
