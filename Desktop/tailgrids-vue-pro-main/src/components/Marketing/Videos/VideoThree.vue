      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="relative z-10 overflow-hidden">
            ...
            />
            <div class="relative z-10 bg-[#090E34] bg-opacity-90 px-8 py-20 md:py-[120px]">
              <div class="mx-auto max-w-[500px] text-center">
                ...
                <span class="mx-auto mb-4 block h-1 w-[60px] bg-white rounded"></span>
                <p class="mb-[50px] text-base text-white md:text-lg">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin at quam fringilla,
                  scelerisque nisl diam.
                </p>
                <a
                  href="javascript:void(0)"
                  @click="openVideo"
                  class="z-20 mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-white dark:bg-dark-3 text-primary dark:text-white md:h-[100px] md:w-[100px]"
                >
                  <svg width="23" height="27" viewBox="0 0 23 27" class="fill-current ml-1">
                    <path
