    ...
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div
            class="relative z-10 overflow-hidden rounded-xl bg-white dark:bg-dark-2 p-11 shadow-pricing-3"
          >
              ...
              <table class="table-auto">
                ...
                <thead>
                  <tr>
                    ...
                    <template v-for="(card, cardIndex) in pricingCards" :key="cardIndex">
                      <th class="w-1/4 min-w-[200px] px-5 xl:pt-6">
                        <div class="mb-10 text-left">
                          ...
                          >
                            <span class="pr-0.5">{{ card.price }}</span>
                          ...
                          <a
                            ...
                            class="block w-full rounded-md p-3 text-center text-base font-medium text-white transition hover:bg-opacity-90"
                ...
                <tbody>
                  <tr>
                    <td class="border-t border-[#EEEEEE] dark:border-dark-3 py-5 px-5">
                      <h5 class="text-base font-medium text-dark dark:text-white">Key Features</h5>
                    </td>
                    <td class="border-t border-[#EEEEEE] dark:border-dark-3 py-5 px-5">
                  ...
                  <template v-for="(feature, featureIndex) in featureRows" :key="featureIndex">
                    <tr>
                      <td class="border-t border-[#EEEEEE] dark:border-dark-3 py-5 px-5">
                      ...
                      <template v-for="(item, index) in feature.limits" :key="index">
                        <td class="border-t border-[#EEEEEE] dark:border-dark-3 py-5 px-5">
                      ...
                      <template v-for="(item, index) in feature.icons" :key="index">
                        <td class="border-t border-[#EEEEEE] dark:border-dark-3 py-5 px-5">
                          <p
                            v-if="item === 'check'"
                  ...
                  <!-- <FeatureRow title="All Pro Components" icons={['check', 'check', 'check']} />
                  <FeatureRow title="Design Source Files" icons={['cross', 'check', 'check']} /> -->
                </tbody>
              </table>
            </div>
