      ...
      <div class="relative z-10 overflow-hidden rounded bg-[#c4c4c4] dark:bg-dark-3">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 lg:w-1/2">
            <div class="py-14 px-6 sm:px-10 md:py-20 md:px-[70px] lg:pl-11 lg:pr-0">
              <h2
                class="text-dark dark:text-white mb-9 text-2xl font-bold leading-snug md:text-[40px]/[48px]"
              >
                Get support through our application.
              </h2>
              <p class="text-lg text-body-color dark:text-dark-6 mb-11">
              ...
              <div class="flex flex-wrap items-center">
                <a
                  ...
                  class="text-dark dark:text-white hover:text-primary my-1 mr-4 inline-flex h-[70px] items-center dark:bg-dark-2 justify-center rounded-lg bg-white px-5 text-center text-base font-medium transition duration-200 shadow-[0px_5px_18px_0px_rgba(0,0,0,0.08)] sm:px-6 md:text-lg"
                >
                  <span
                    class="flex items-center justify-center mr-4 rounded-md bg-dark dark:bg-white/10 h-11 w-11"
                  >
                    <svg
                      width="24"
                      height="24"
                ...
                <a
                  href="javascript:void(0)"
                  class="group text-dark hover:text-primary my-1 inline-flex h-[70px] items-center justify-center rounded-lg px-5 text-center text-base font-medium transition duration-200 hover:bg-white dark:text-dark-6 dark:hover:bg-dark-2 sm:px-6 md:text-lg"
                >
                  <span class="mr-4">
                    <svg
                      width="24"
        ...
        <div class="hidden md:block">
          ...
          <span class="absolute top-20 right-0 z-[-1]">
            <svg
              width="95"
              height="161"
              viewBox="0 0 95 161"
