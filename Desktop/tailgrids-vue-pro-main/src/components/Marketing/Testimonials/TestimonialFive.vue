...
const testimonialItems = ref<TestimonialItem[]>([
  ...
  {
    image:
      'https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-05/image-02.jpg',
    name: 'Anee Doe',
    position: 'CEO @ Trorex.',
    details: `I believe in lifelong learning and Learn. is a great place to learn from experts. I've learned a lot and recommend it to all my friends and familys.`
  },
  {
    image:
      'https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-05/image-03.jpg',
    name: 'Dipali Dow',
  ...
  {
    image:
      'https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-05/image-04.jpg',
    name: 'John Doe',
      ...
      <div class="-mx-4 flex flex-wrap justify-center">
        <div class="w-full px-4">
          <div class="mb-[60px] max-w-[510px] lg:mb-[70px]">
            <span class="text-primary mb-2 block text-lg font-semibold"> Testimonials </span>
            <h2
          ...
          <div class="w-full px-4 md:w-1/2">
            ...
            >
              <div class="mb-10 flex items-center">
                ...
                <div class="w-full">
                  <h5 class="text-dark dark:text-white mb-1 text-lg font-semibold">
                    {{ item.name }}
                  </h5>
                  <p class="text-body-color dark:text-dark-6 text-xs">{{ item.position }}</p>
                </div>
              </div>
              <p class="text-body-color dark:text-dark-6 text-base">“{{ item.details }}”</p>
              <div>
