...
const testimonialItems = ref<TestimonialItem[]>([
  {
    image:
    ...
    <div class="container">
      <div class="flex flex-wrap justify-center">
        <div class="w-full md:w-11/12 lg:w-10/12 xl:w-8/12">
          <div class="mb-8 max-w-[510px]">
            <span class="text-primary mb-2 block text-lg font-semibold"> What People Says </span>
            <h2
      ...
      <div class="swiper-container swiper" ref="swiperContainer">
        <div class="swiper-wrapper">
          <template v-for="(item, index) in testimonialItems" :key="index">
            <div class="swiper-slide">
              <div class="relative z-10 flex justify-center">
                <div class="relative w-full pb-16 md:w-11/12 md:pb-0 lg:w-10/12 xl:w-8/12">
                  <div
                    class="relative z-10 items-center overflow-hidden bg-white shadow-testimonial dark:bg-dark-2 md:flex"
                  >
                    <div
                      class="w-full max-w-[150px] px-6 pt-10 sm:px-10 md:max-w-[270px] md:px-0 md:pt-0"
                    >
                      <img :src="item.image" alt="image" class="w-full" />
                    </div>
                    <div class="w-full px-6 py-10 sm:px-10 md:py-14">
                      <div class="icon mb-5">
                        <svg
                          width="39"
                          height="22"
                      ...
                      <h4 class="mb-1 text-xl font-semibold text-dark dark:text-white">
                        {{ item.name }}
                      </h4>
                      <h6 class="mb-4 text-sm font-normal text-body-color dark:text-dark-6">
                        {{ item.position }}
                      </h6>
        ...
        <div>
          <div class="prev-arrow cursor-pointer">
            <button
              @click="onPrevClick"
              class="absolute z-10 left-0 top-full flex h-10 w-10 items-center justify-center bg-white text-dark shadow-input transition-all hover:bg-primary hover:text-white dark:bg-dark-2 dark:text-white md:-left-12 md:top-1/2 lg:left-0"
            >
              <svg
                width="20"
                height="20"
          ...
          <div class="next-arrow cursor-pointer">
            <button
              @click="onNextClick"
              class="absolute z-10 left-auto right-0 top-full flex h-10 w-10 items-center justify-center bg-white text-dark shadow-input transition-all hover:bg-primary hover:text-white dark:bg-dark-2 dark:text-white md:-right-12 md:top-1/2 lg:right-0"
            >
              <svg
                width="20"
                height="20"
