...
<template>
  ...
  <header class="py-16 bg-gray-2 dark:bg-dark">
    <div class="mx-auto w-full px-4 xl:container">
      <div class="flex items-center justify-between bg-white dark:bg-dark-2 px-4 xl:px-[30px]">
        <div class="mr-4 max-w-[100px] lg:mr-[52px]">
          <a href="javascript:void(0)" class="block py-4">
            <img
              ...
              <ul class="flex items-center space-x-[30px]">
                <template v-for="(item, index) in navItems" :key="index">
                  <li>
                    <a
                      :href="item.href"
                      class="after relative block py-[23px] px-[2px] text-base font-medium text-body-color dark:text-dark-6 duration-200 after:absolute after:bottom-0 after:left-0 after:block after:h-0.5 after:w-full after:rounded-t hover:text-primary hover:after:bg-primary"
                    >
                      {{ item.label }}
                    </a>
                  </li>
          ...
          <div>
            <div class="flex items-center justify-end">
              ...
              <div class="relative mr-3 hidden sm:block">
                <a
                  href="javascript:void(0)"
                  class="block text-body-color dark:text-dark-6 hover:text-white"
                >
                  <svg
                    width="20"
                    height="21"
              ...
              <div class="relative mr-[18px] hidden sm:block">
                <a
                  href="javascript:void(0)"
                  class="relative block text-body-color dark:text-dark-6 hover:text-primary"
                >
                  <span
                    class="absolute -top-0.5 -right-0.5 block h-[10px] w-[10px] rounded-full border border-white dark:border-dark-2 bg-[#DC3545]"
                  ></span>
                  <svg
                    width="24"
                    height="24"
              ...
              <div class="relative hidden mr-6 sm:block">
                <a
                  href="javascript:void(0)"
                  class="relative block text-body-color dark:text-dark-6 hover:text-primary"
                >
              ...
              <div class="group relative">
                <div class="w-8 h-8 rounded-full cursor-pointer sm:h-10 sm:w-10">
                  <img
                ...
                >
                  <template v-for="(item, index) in userDropdownItems" :key="index">
                    <a
                      :href="item.href"
                      class="block px-4 py-2 text-sm font-medium rounded text-body-color dark:text-dark-6 hover:bg-gray-2 dark:hover:bg-dark hover:text-primary"
                    >
                      {{ item.label }}
                    </a>
                  </template>
