...
<template>
  ...
  <header class="bg-gray-2 dark:bg-dark py-16">
    <div class="mx-auto w-full px-4 xl:container">
      <div class="flex items-center justify-between bg-dark dark:bg-dark-2 px-4 xl:px-[30px]">
        <div class="mr-4 max-w-[100px] lg:mr-[58px]">
        ...
        <div class="flex w-full items-center justify-end md:justify-between">
              ...
              <ul class="flex items-center space-x-10">
                <template v-for="(item, index) in navItems" :key="index">
                  <li>
                    <a
                      :href="item.href"
                      class="relative block py-[18px] px-[2px] text-sm font-medium text-white/50 hover:text-white duration-200 after:absolute after:bottom-0 after:left-0 after:block after:h-[3px] after:w-full after:rounded-t hover:after:bg-white/50"
                    >
                      {{ item.label }}
                    </a>
                  </li>
          ...
          <div>
            <div class="flex items-center justify-end">
              <div class="relative mr-[38px] hidden w-full max-w-[250px] lg:block">
                <input
                  type="text"
                  placeholder="Search..."
                  class="w-full shadow-product rounded border border-body-color/30 bg-white/5 py-[5px] pl-4 pr-10 text-sm font-medium text-dark-6 outline-none"
                />
                <button class="absolute right-3 top-1/2 -translate-y-1/2">
                  ...
                  >
                    <g opacity="0.5" clip-path="url(#clip0_1050_7232)">
                      <path
              ...
              <div class="relative mr-3 hidden sm:block">
                <a
                  href="javascript:void(0)"
                  class="relative block text-body-color dark:text-dark-6 hover:text-white"
                >
                  <span
                    class="absolute -top-0.5 -right-0.5 block h-[10px] w-[10px] rounded-full border-[1.5px] border-dark dark:border-dark-2 bg-green"
                  ></span>
                  <svg
                    width="20"
                    height="21"
                    ...
                    class="fill-current"
                  >
                    <g clip-path="url(#clip0_1050_7236)">
                      <path
              ...
              <div class="group relative">
                <div class="h-7 w-7 cursor-pointer rounded-full">
                  <img
