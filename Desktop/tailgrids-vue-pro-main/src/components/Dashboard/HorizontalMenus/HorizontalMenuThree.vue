...
<template>
  ...
  <header class="bg-gray-2 dark:bg-dark py-16">
    <div class="mx-auto w-full px-4 lg:container">
      <div
        class="flex items-center justify-end bg-white dark:bg-dark-2 py-4 px-6 sm:justify-between"
      >
        <div class="hidden sm:block">
          <div class="flex items-center">
            <span class="mr-4 text-body-color dark:text-dark-6">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <input
              ...
              class="w-full text-base text-secondary-color dark:text-dark-6 outline-none bg-transparent"
            />
          </div>
        </div>
        ...
        <div>
          <div class="flex items-center">
            <div class="mr-[18px] hidden md:block">
              <a
            ...
            <div class="group relative">
              <a href="javascript:void(0)" class="flex items-center">
                ...
                <img
                  ...
                  alt="avatar"
                  class="h-12 w-[48px] rounded-full object-cover object-center"
                />
                <span class="text-body-color dark:text-dark-6 ml-3">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
