...
<template>
  ...
  <header class="bg-gray-2 dark:bg-dark py-16">
    <div class="mx-auto w-full px-4 xl:container">
      <div class="flex items-center justify-between bg-primary px-4 xl:px-[30px]">
        <div class="mr-4 max-w-[100px] lg:mr-[88px]">
        ...
        <div class="flex w-full items-center justify-between">
          <div class="mr-4 flex items-center">
            <div class="group relative mr-4">
              <button
                ...
                class="flex h-9 w-9 items-center justify-center rounded bg-white/[0.08] text-white"
              >
                <svg
                  width="21"
                  height="20"
              ...
              <nav
                ...
                :class="{
                  'invisible opacity-0 top-[120%]': !open,
                  'visible opacity-100 top-full': open
                }"
              >
            ...
            <div class="relative mr-11 hidden w-full max-w-[250px] lg:block">
              <input
                type="text"
                placeholder="Search..."
                class="h-9 w-full rounded border border-transparent bg-white/[0.08] pr-4 pl-10 text-sm font-medium text-white/50 outline-none focus:border-white"
              />
              <button class="absolute left-[14px] top-1/2 -translate-y-1/2 text-white/50">
                <svg
                  width="15"
                  height="14"
                  viewBox="0 0 15 14"
          ...
          <div>
            <div class="flex items-center justify-end">
              <div class="relative mr-[30px] hidden sm:inline-flex">
                <div class="h-4 w-6">
                  <img
              ...
              <div class="relative mr-5 hidden sm:inline-flex">
                <button>
                  <svg
                    width="19"
                    height="18"
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_1050_7423)">
                      <path
              ...
              <div class="relative mr-7 hidden sm:block">
                <a href="javascript:void(0)" class="relative block">
                  <span
                    class="absolute -top-2 -right-[6px] block rounded-full bg-[#FF6756] px-[6px] text-xs font-medium text-white"
                  >
                    3
                  </span>
                  <svg
              ...
              <div class="group relative">
                <div class="flex cursor-pointer items-center">
                  <img
                    ...
                    alt="avatar"
                    class="h-8 w-8 rounded-full border-2 border-white border-opacity-20 object-cover object-center"
                  />
                  <span class="pl-[10px] pr-[5px] text-sm font-medium text-white"> Patrick </span>
                  <span>
                    <svg
                      width="15"
                      height="14"
