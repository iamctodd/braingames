...
<template>
  <section class="bg-gray-2 dark:bg-dark pt-20 pb-12 lg:pb-[90px] lg:pt-[120px]">
    <div class="mx-auto px-4 md:container">
      <div class="-mx-4 flex flex-wrap">
        ...
        >
          <div
            class="relative mb-8 flex items-center rounded-[10px] bg-white dark:bg-dark-2 py-10 px-6 shadow-1 dark:shadow-box-dark sm:px-10 md:px-6 xl:px-10"
          >
            <div
            ...
            <div>
              <p
                class="font-bold text-dark dark:text-white text-2xl xl:leading-[35px] xl:text-[28px]"
              >
                {{ statistic.value }}
              </p>
