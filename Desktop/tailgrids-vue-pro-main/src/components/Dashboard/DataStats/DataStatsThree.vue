  ...
  <section class="bg-gray-2 dark:bg-dark pt-20 pb-12 lg:pb-[90px] lg:pt-[120px]">
    <div class="mx-auto px-4 md:container">
      <div class="-mx-4 flex flex-wrap">
        ...
        >
          <div
            class="mb-8 rounded-lg border border-stroke dark:border-dark-3 bg-white dark:bg-dark-2 p-6 lg:px-4 xl:px-6"
          >
            <div
              v-html="statistic.icon"
              class="mb-[18px] flex h-[50px] w-[50px] items-center justify-center rounded-full bg-primary/[0.06] dark:bg-primary/10 text-primary"
            ></div>
            <div class="flex items-end justify-between">
              <div>
                <span
                  class="block text-2xl font-bold leading-none text-dark dark:text-white lg:text-xl xl:text-2xl mb-1"
                >
                  {{ statistic.value }}
                </span>
