...
const cardItems = ref([
  {
    authorImg: 'https://cdn.tailgrids.com/2.0/image/application/images/cards/card-13/author-01.png',
  ...
  {
    authorImg: 'https://cdn.tailgrids.com/2.0/image/application/images/cards/card-13/author-02.png',
    title: 'Card Title here',
    details:
      'Lorem ipsum dolor sit amet, vehiculaum ero felis loreum fitiona fringilla goes scelerisque Interdum et.',
    buttonText: 'Learn More',
  ...
  {
    authorImg: 'https://cdn.tailgrids.com/2.0/image/application/images/cards/card-13/author-03.png',
    title: 'Card Title here',
    details:
      'Lorem ipsum dolor sit amet, vehiculaum ero felis loreum fitiona fringilla goes scelerisque Interdum et.',
    buttonText: 'Learn More',
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <template v-for="(item, index) in cardItems" :key="index">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              class="relative flex p-6 mb-10 bg-white border border-stroke dark:bg-dark-2 dark:border-dark-3"
            >
              <div
                class="mr-5 h-11 w-full max-w-[44px] overflow-hidden rounded-full lg:mr-4 lg:h-10 lg:max-w-[40px] xl:mr-5 xl:h-11 xl:max-w-[44px]"
              >
                <img
                  :src="item.authorImg"
                  alt="author"
              ...
              <div class="w-full">
                <h3>
                  <a
                    ...
                    class="inline-block pr-4 mb-3 text-base font-medium hover:text-primary text-dark dark:text-white sm:text-lg lg:text-base xl:text-lg"
                  >
                    {{ item.title }}
                  </a>
                </h3>
                <p class="text-body-color dark:text-dark-6 mb-[18px] text-sm">
                  L{{ item.details }}
                </p>
                <a
                  :href="item.buttonLink"
                  class="group inline-flex items-center text-sm font-medium duration-300 hover:text-primary text-body-color dark:text-dark-6"
                >
                  {{ item.buttonText }}
              ...
              <button
                class="text-body-color hover:text-primary absolute right-[18px] top-[18px] dark:text-dark-6"
              >
                <svg
                  width="16"
                  height="16"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g opacity="0.8" clip-path="url(#clip0_3187_680)">
                    <path
