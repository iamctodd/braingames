...
<template>
  <div class="text-center">
    <div
      class="inline-flex p-3 mb-12 bg-white rounded shadow-[0px_1px_3px_0px_rgba(0,0,0,0.13)] dark:bg-dark-2"
    >
      <ul class="-mx-[6px] flex items-center">
        <li class="px-[6px]">
          ...
          >
            <span>
              <svg width="5" height="11" viewBox="0 0 5 11" class="fill-current stroke-current">
                <path
        ...
        <li v-for="page in visiblePages" :key="page" class="px-[6px]">
          <a
            href="javascript:void(0)"
            @click="goToPage(page)"
            class="min-w-[24px] flex h-6 px-1 items-center justify-center rounded text-base text-body-color dark:hover:bg-white/5 hover:bg-[#EDEFF1] dark:hover:text-white"
        ...
        <li class="px-[6px]" v-if="showEllipsisBeforeLastPage">
          <a
            href="javascript:void(0)"
            class="flex h-6 w-6 items-center justify-center rounded text-base text-[#838995]"
          >
            ...
          </a>
        </li>
        <li v-if="totalPages > MAX_VISIBLE_PAGES" class="px-[6px]">
          <a
            href="javascript:void(0)"
