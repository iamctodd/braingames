...
<template>
  <div class="text-center">
    <div
      class="mb-12 inline-flex rounded-full dark:bg-dark-2 bg-white py-2 px-3 shadow-[0px_1px_3px_0px_rgba(0,0,0,0.13)]"
    >
      <ul class="-mx-[6px] flex items-center">
        <li class="px-[6px]">
          <a
            ...
            class="flex items-center justify-center text-base border rounded-full text-dark hover:border-primary hover:bg-primary h-9 w-9 border-stroke dark:text-white dark:border-dark-3 hover:text-white"
          >
            <span>
              <svg width="16" height="7" viewBox="0 0 16 7" class="fill-current">
                <path
        ...
        <li v-for="page in pages" :key="page" class="px-[6px]">
          <a
            href="javascript:void(0)"
            @click="goToPage(page)"
            class="flex items-center justify-center text-base border rounded-full hover:border-primary hover:bg-primary h-9 w-9 border-stroke dark:border-dark-3 text-body-color hover:text-white"
            >{{ page }}</a
          >
        </li>
        <li class="px-[6px]">
