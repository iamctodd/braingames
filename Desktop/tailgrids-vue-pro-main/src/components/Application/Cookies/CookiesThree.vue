<template>
  ...
  <section class="pt-6 pb-4 bg-dark dark:bg-dark-2">
      ...
      <div class="flex flex-wrap items-center -mx-4">
        ...
        <div class="w-full px-4 lg:w-5/12">
          <div class="flex flex-wrap items-center gap-6 lg:justify-end">
            <a href="javascript:void(0)" class="text-base font-medium text-white hover:underline">
              Cookie Policies
            </a>
            <div class="flex items-center mb-2 space-x-4">
              <button
                class="inline-flex items-center justify-center py-3 text-base font-medium text-center bg-white rounded-md text-body-color dark:text-dark-6 shadow-1 dark:shadow-none dark:bg-dark px-7 hover:bg-gray-2 dark:hover:bg-dark-3"
              >
                Accept Cookies
              </button>
              <button class="inline-flex items-center justify-center text-center text-white">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
