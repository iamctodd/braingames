<template>
  ...
  <section class="bg-white pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] dark:bg-dark">
    <div class="container mx-auto">
      <div
        class="bg-primary xs:px-10 flex flex-wrap items-center justify-between rounded-lg py-8 px-6 md:px-8 lg:px-10"
      >
        <div class="w-full md:w-7/12 lg:w-2/3">
          <div class="mb-6 items-center sm:flex md:mb-0">
            <div class="mr-5 mb-3 sm:mb-0">
              <svg
                width="64"
                height="64"
                viewBox="0 0 64 64"
            ...
            <div>
              <h4 class="xs:text-2xl mb-1 text-xl font-semibold text-white md:text-xl lg:text-2xl">
                We use cookies
              </h4>
        ...
        <div class="w-full md:w-5/12 lg:w-1/3">
          <div class="flex items-center space-x-3 md:justify-end">
            <button
              class="text-body-color dark:text-dark-6 shadow-1 dark:shadow-none hover:text-primary inline-flex items-center justify-center rounded-md bg-white dark:bg-dark-2 py-3 px-7 text-center text-base font-medium hover:bg-gray-2"
            >
              Accept
            </button>
            <button
              class="shadow-card inline-flex h-12 w-12 items-center justify-center rounded bg-white/10 text-center text-base font-semibold text-white hover:bg-opacity-10"
            >
              <svg
                width="20"
                height="20"
