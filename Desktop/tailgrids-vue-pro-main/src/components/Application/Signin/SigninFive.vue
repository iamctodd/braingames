    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div
            class="relative mx-auto max-w-[440px] w-full overflow-hidden rounded-[20px] bg-white py-16 px-7 sm:px-12 shadow-[0px_39px_23px_-27px_rgba(0,0,0,0.10)] dark:bg-dark-2"
          >
            <div class="items-center justify-between mb-10 text-center sm:flex sm:text-left">
              <div class="mb-2 inline-block max-w-[120px] sm:mb-0">
                <img
              ...
              <p class="text-base font-medium text-black dark:text-white">
                <span class="pr-0.5">Have account?</span>
                <a href="javascript:void(0)" class="text-primary hover:underline"> Log in </a>
              </p>
            </div>
            <div class="text-left">
              <h2
                class="mb-2 text-xl font-bold text-dark dark:text-white sm:text-[28px] !leading-[1.6]"
              >
            ...
            <form>
              <div class="mb-6">
                <input
                  ...
                  class="w-full border-b border-stroke dark:border-dark-3 bg-transparent py-[10px] text-base font-medium text-body-color dark:text-white outline-none focus-visible:shadow-none focus:border-primary"
                />
              </div>
              <div class="mb-6">
                <input
            ...
            <div class="relative z-10 flex items-center justify-center mb-8">
              <span
                class="absolute top-1/2 left-0 -z-10 hidden h-[1px] w-full -translate-y-1/2 bg-stroke sm:block dark:bg-dark-3"
              ></span>
              <p
            ...
            <div class="flex items-center justify-center space-x-5">
              <button
                class="flex items-center justify-center w-[50px] h-[50px] border rounded-[14px] border-stroke hover:bg-primary/10 dark:border-dark-3"
              >
                <svg
                  width="22"
                  height="22"
                ...
                >
                  <g clip-path="url(#clip0_1369_296)">
                    <path
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1369_292)">
                    <path
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1369_288)">
                    <path
