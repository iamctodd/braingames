    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <h2
            class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-[45px] !leading-[1.22]"
          >
            Sign Up
          </h2>
          <p class="dark:text-dark-6 mb-8 max-w-[510px] text-base text-body-color">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In non dui aliquet,
            pellentesque tellus ac, faucibus ex.
          </p>
          <div>
            <div class="flex items-center mb-8">
              <span class="pr-3 text-lg font-medium text-primary"> Sign Up With </span>
              <span class="h-[2px] w-12 bg-primary"></span>
            </div>
            <div class="flex flex-wrap -mx-3">
              <div class="w-full px-3 md:w-1/2 xl:w-1/2">
                <button
                  class="flex items-center justify-center w-full p-4 mb-8 text-sm border rounded-md xl:text-base border-stroke text-body-color hover:border-primary dark:text-dark-6 dark:border-dark-3 hover:text-primary sm:text-base lg:px-2 lg:text-sm xl:px-4"
                >
                  <span class="pr-3">
                    <svg
                      width="20"
                    ...
                    >
                      <g clip-path="url(#clip0_1368_888)">
                        <path
                ...
                >
                  <span class="pr-3">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clip-path="url(#clip0_1375_409)">
                        <path
              ...
              <div class="flex flex-wrap -mx-2">
                <div class="w-full px-2 sm:w-1/2">
                  <div class="mb-4">
                    <label
                      for="username"
                      class="block mb-2.5 text-base font-medium text-dark dark:text-white"
                    >
                      Username
                    </label>
                    <input
                      type="text"
                      name="username"
                      class="w-full px-5 py-3 text-base bg-transparent border rounded-md outline-none border-stroke dark:text-white text-body-color focus:border-primary dark:border-dark-3"
                    />
                  </div>
                </div>
                <div class="w-full px-2 sm:w-1/2">
                  ...
                  <div class="mb-9">
                    ...
                    >
                      <div class="relative pt-[2px]">
                        ...
                        <div
                          class="flex items-center justify-center w-5 h-5 mr-3 border rounded box border-stroke dark:border-dark-3"
                        >
                      ...
                      <p class="text-base dark:text-dark-6 text-body-color">
                        I’ve read and agree with Terms of Servicec and our Privacy Policy
                      </p>
                    </label>
                  </div>
                </div>
                <div class="w-full px-2">
                  <button
                    class="flex items-center justify-center rounded-md bg-primary py-[14px] px-14 text-base font-medium text-white"
                  >
                    Create Account
                  </button>
                </div>
