    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4">
          <div
            class="mx-auto max-w-[630px] rounded-[20px] border border-stroke dark:bg-dark-2 dark:border-dark-3 bg-white py-10 px-6 sm:p-[70px]"
          >
            <h3
              class="mb-2.5 text-2xl font-bold text-dark dark:text-white sm:text-[28px] !leading-[1.6]"
            >
              Sign up to TailGrids
            </h3>
            <p class="text-base dark:text-dark-6 max-w-[315px] mb-7 text-body-color">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit.
            </p>
            <div class="flex items-center mb-6 space-x-4">
              <button
                class="flex h-[50px] items-center justify-center rounded-md border border-stroke text-sm font-semibold text-body-color hover:text-primary hover:border-primary dark:text-dark-6 sm:w-auto sm:px-7 dark:border-dark-3"
              >
                <span class="sm:pr-3">
                  <svg
                    width="18"
                ...
                <span class="hidden sm:inline-flex"> Sign up with Google </span>
              </button>
              <button
                class="flex h-[50px] w-[52px] items-center justify-center rounded-md bg-[#03A9F4]"
              >
                <svg
                  width="23"
                  height="18"
              ...
              <button
                class="flex h-[50px] w-[52px] items-center justify-center rounded-md bg-[#0080FF]"
              >
                <svg
                  width="10"
                  height="20"
            ...
            <div class="relative z-10 flex items-center justify-center mb-8">
              <span
                class="absolute top-1/2 left-0 -z-10 hidden h-[1px] w-full -translate-y-1/2 dark:bg-dark-3 bg-stroke sm:block"
              ></span>
              <p
                class="text-base font-medium bg-white dark:bg-dark-2 dark:text-dark-6 text-body-color sm:px-4"
              >
              ...
              <div class="flex flex-wrap -mx-2">
                <div class="w-full px-2 sm:w-1/2">
                  <div class="mb-4">
                    <label
                      for="name"
                      class="block mb-2.5 text-base font-medium dark:text-white text-dark"
                    >
                      Full Name
                    </label>
                    <input
                      type="text"
                      name="name"
                      class="w-full px-5 py-3 text-base border rounded-md outline-none border-stroke dark:text-white dark:bg-dark dark:border-dark-3 bg-gray-2 text-body-color focus:border-primary"
                    />
                  </div>
                </div>
                <div class="w-full px-2 sm:w-1/2">
                ...
                <div class="w-full px-2">
                  <div class="mb-8">
                    <label
                      ...
                      class="flex text-base cursor-pointer text-body-color dark:text-dark-6"
                    >
                      <div class="relative pt-[2px]">
                        <input type="checkbox" id="checkboxLabelTwo" class="sr-only" />
                        <div
                          class="flex items-center justify-center w-5 h-5 mr-3 border rounded box border-gray-2 dark:border-dark-3 dark:bg-dark"
                        >
                      ...
                      <p class="text-base dark:text-dark-6 text-body-color">
                        <span class="pr-0.5"> By creating account means you agree to the </span>
                        <a href="javascript:void(0)" class="text-primary hover:underline">
                          Terms and Conditions
                        </a>
                        <span class="px-0.5">, and our</span>
                        <a href="javascript:void(0)" class="text-primary hover:underline">
                          Privacy Policy
                        </a>
                      </p>
                ...
                <div class="w-full px-2">
                  <button
                    class="flex items-center justify-center rounded-md bg-primary py-[14px] px-14 text-sm font-medium text-white"
                  >
                    Create Account
                  </button>
                </div>
