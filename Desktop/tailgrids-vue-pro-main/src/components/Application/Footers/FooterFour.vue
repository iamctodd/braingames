...
const menus = ref([
  ...
  },
  {
    title: 'Additional',
    items: [
      { text: 'Our story', link: 'javascript:void(0)' },
      { text: 'Who we are', link: 'javascript:void(0)' },
      { text: 'Our process', link: 'javascript:void(0)' },
      { text: 'Latest news', link: 'javascript:void(0)' }
    ]
  }
])
...
<template>
  ...
  <footer class="bg-[#090E34] relative z-10 overflow-hidden pt-20 lg:pt-[120px]">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        ...
        <div
          v-for="menu in menus"
          :key="menu.title"
          class="w-full px-4 sm:w-1/2 lg:w-3/12 xl:w-2/12"
        >
          <div class="w-full mb-10">
    ...
    <div class="mt-12 border-t border-[#8890A46E] py-8 lg:mt-[60px]">
      <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              <div class="flex flex-wrap items-center justify-center -mx-3 md:justify-start">
                <a
                  href="javascript:void(0)"
                  class="px-3 text-base text-gray-7 hover:underline underline-offset-2 hover:text-white"
                >
                  Privacy policy
                </a>
                <a
