...
const menus = ref([
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Who we are', link: 'javascript:void(0)' }
    ]
  }
])
</script>
  ...
  <footer class="relative z-10 bg-white dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            ...
            <p class="text-base text-body-color dark:text-dark-6 mb-7">
              Lorem ipsum dolor amet consectetur adipiscing elit do eiusmod tempor incididunt ut
              labore et dolore.
            </p>
        ...
        <div v-for="menu in menus" :key="menu.title" class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
          ...
          <div class="w-full mb-10">
            ...
            <form class="relative w-full mb-5 overflow-hidden rounded">
              <input
                ...
                class="w-full h-12 px-5 text-sm bg-transparent border rounded outline-none border-stroke text-body-color dark:text-dark-6 dark:border-dark-3 focus:border-primary focus-visible:shadow-none"
              />
              <button
                type="submit"
