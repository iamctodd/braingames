    ...
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full mb-10">
            ...
            <ul class="space-y-3">
              <li v-for="item in menu.items" :key="item.text">
                <a
                  :href="item.link"
                  class="inline-block text-base leading-loose text-white/70 hover:text-white hover:underline underline-offset-2"
                >
                  {{ item.text }}
                </a>
              </li>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="w-full mb-10">
            <h4 class="text-lg font-semibold text-white mb-9">Follow Us On</h4>
            <div class="flex items-center mb-6">
              <a
                href="javascript:void(0)"
                class="flex items-center justify-center w-8 h-8 mr-3 text-white border rounded-full hover:text-primary border-stroke/30 hover:border-white hover:bg-white sm:mr-4 lg:mr-3 xl:mr-4"
              >
