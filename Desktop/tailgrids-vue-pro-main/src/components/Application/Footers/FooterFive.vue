...
const menus = ref([
  {
    title: 'Company',
    items: [
      { text: 'About company', link: 'javascript:void(0)' },
      { text: 'Company services', link: 'javascript:void(0)' },
      { text: 'Job opportunities', link: 'javascript:void(0)' },
      { text: 'Creative people', link: 'javascript:void(0)' }
    ]
  },
  {
    title: 'Customer',
    items: [
      { text: 'Client support', link: 'javascript:void(0)' },
      { text: 'Latest news', link: 'javascript:void(0)' },
      { text: 'Company story', link: 'javascript:void(0)' },
      { text: 'Pricing packages', link: 'javascript:void(0)' }
    ]
  }
])
</script>
...
<template>
  ...
  <footer class="bg-[#090E34] relative z-10">
    <span class="absolute top-0 left-0 block w-1/2 h-2 bg-primary"></span>
    <span class="absolute top-0 right-0 block w-1/2 h-2 bg-secondary"></span>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          <div class="w-full px-4 lg:w-1/2">
            <div class="w-full mb-5">
              <h3 class="text-2xl font-bold text-white sm:text-[28px] sm:leading-snug">
              ...
              <form class="flex flex-wrap">
                <div class="relative mr-5 mb-3 w-full max-w-[370px]">
                  <input
                    ...
                    class="w-full pr-5 bg-white/5 border border-white/[.08] rounded outline-none h-[52px] pl-14 focus:border-primary focus-visible:shadow-none text-dark-6"
                  />
                  <label class="absolute -translate-y-1/2 text-dark-6 left-5 top-1/2">
                    <svg
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                ...
                <button
                  type="submit"
                  class="px-7 mb-3 text-white transition rounded bg-primary h-[52px] border border-transparent hover:bg-opacity-90"
                >
                  Subscribe
                </button>
              </form>
    ...
    <div class="container pt-14 lg:pt-20">
      <div class="flex flex-wrap -mx-4">
        ...
        <div
          v-for="menu in menus"
          :key="menu.title"
          class="w-full px-4 sm:w-1/2 lg:w-3/12 2xl:w-2/12"
        >
          <div class="w-full mb-10">
            ...
            <ul class="space-y-3">
              <li v-for="item in menu.items" :key="item.text">
                <a
                  :href="item.link"
                  class="inline-block text-base leading-loose text-gray-7 hover:underline underline-offset-2 hover:text-white"
                >
                  {{ item.text }}
                </a>
              </li>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-4/12 2xl:w-2/12">
          <div class="w-full mb-10">
            <h4 class="text-lg font-semibold text-white mb-9">Contact Info</h4>
            <ul>
              <li>
                <p class="inline-flex items-start mb-3 text-base leading-loose text-gray-7">
      ...
      <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              <div class="flex flex-wrap items-center justify-center -mx-3 md:justify-end">
                <a href="javascript:void(0)" class="px-3 text-base text-gray-7 hover:text-white">
                  Privacy policy
                </a>
                <a href="javascript:void(0)" class="px-3 text-base text-gray-7 hover:text-white">
                  Legal notice
