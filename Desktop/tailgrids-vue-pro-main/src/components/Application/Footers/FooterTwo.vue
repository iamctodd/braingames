      ...
      <div class="flex flex-wrap -mx-4 lg:mb-14">
        <div class="w-full px-4 md:w-2/3 lg:w-1/3">
          <div class="w-full mb-12">
            <h4 class="text-dark dark:text-white text-3xl font-medium xl:text-[32px]">
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="w-full mb-12">
            <div class="flex">
              ...
              <div>
                <h5 class="mb-4 text-lg font-semibold text-dark dark:text-white">Our Location</h5>
        ...
        <div class="w-full px-4 md:w-1/2 lg:w-1/3">
          <div class="w-full mb-12">
            <div class="flex">
              ...
              <div>
                <h5 class="mb-4 text-lg font-semibold text-dark dark:text-white">
                  How Can We Help?
                </h5>
                <p class="mb-2 text-base text-body-color dark:text-dark-6">info@yourdomain.com</p>
        ...
        <div class="flex flex-wrap items-center -mx-4">
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-1/3">
            <div class="w-full py-3">
              <div class="flex items-center justify-center -mx-3 lg:justify-end">
                <a
