<template>
  ...
  <section class="relative z-40 overflow-hidden py-20 lg:py-[120px] bg-white dark:bg-dark">
    <div class="container mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4 lg:w-1/2">
          <div class="w-full mb-14 lg:mb-0">
            <h2
              class="text-dark dark:text-white mb-6 text-[32px] font-bold leading-tight sm:text-[42px] md:pr-5"
            >
              Let’s chat. <br />
              Tell us about your project.
            </h2>
            <p class="mb-8 text-base dark:text-dark-6 text-body-color">
              Let’s create something together
            </p>
            <div
              class="flex items-center p-5 bg-white rounded-lg shadow-[0px_4px_16px_0px_rgba(0,0,0,0.04)] w-max dark:bg-dark-2"
            >
              <div
                class="bg-primary/5 text-primary mr-4 flex h-11 min-w-[44px] items-center justify-center rounded-xl"
              >
                <svg
                  width="22"
                  height="22"
              ...
              <div class="w-full">
                <span class="block text-sm font-medium text-body-color dark:text-dark-6">
                  Mail us at
                </span>
        ...
        <div class="w-full px-4 lg:w-1/2">
          <div class="relative z-20">
            <div class="bg-primary rounded-xl px-8 py-10 sm:p-[60px]">
              <h2 class="mb-8 text-2xl font-bold text-white sm:text-[28px]">Send us a message</h2>
              <form>
                <div class="mb-6">
                  <input
                    type="text"
                    placeholder="Full Name"
                    class="w-full rounded-lg text-base border border-transparent bg-white/20 py-3 px-[14px] text-white placeholder-white placeholder-opacity-60 outline-none focus:border-white focus-visible:shadow-none"
                  />
                </div>
                <div class="mb-6">
                  <input
                ...
                <div class="mb-6">
                  <textarea
                    ...
                    class="w-full resize-none rounded-lg text-base border border-transparent bg-white/20 py-3 px-[14px] text-white placeholder-white placeholder-opacity-60 outline-none focus:border-white focus-visible:shadow-none"
                  ></textarea>
                  <label class="block mt-6 text-base font-medium text-white">
                ...
                <div>
                  <button
                    type="submit"
                    class="w-full px-10 py-3 text-base font-medium text-center transition bg-white border border-transparent rounded-md text-dark hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
              ...
              <div>
                <span class="absolute -left-6 -top-6 z-[-1]">
                  <svg
                    width="48"
                    height="134"
                    viewBox="0 0 48 134"
                ...
                <span class="absolute -right-6 -bottom-6 z-[-1]">
                  <svg
                    width="48"
                    height="134"
                    viewBox="0 0 48 134"
    ...
    <div>
      ...
      <span class="absolute bottom-0 right-0 z-[-1] dark:opacity-10">
        <svg
          width="1243"
          height="716"
