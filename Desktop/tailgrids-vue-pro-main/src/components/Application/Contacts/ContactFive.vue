          ...
          <div class="w-full px-4 md:w-1/3">
            <div class="mb-10 text-center">
              ...
              <div class="text-center">
                <h4 class="mb-3 text-lg font-semibold text-dark dark:text-white">Email Address</h4>
                <p class="text-base text-body-color dark:text-dark-6">info@example.com</p>
                <p class="text-base text-body-color dark:text-dark-6">support@example.com</p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/3">
            <div class="mb-10 text-center">
              ...
              <div class="text-center">
                <h4 class="mb-3 text-lg font-semibold text-dark dark:text-white">Phone Number</h4>
                <p class="text-base text-body-color dark:text-dark-6">+88 (800) 123 4567</p>
                <p class="text-base text-body-color dark:text-dark-6">+99 094 5445 433</p>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/3">
            <div class="mb-10 text-center">
              ...
              <div class="text-center">
                <h4 class="mb-3 text-lg font-semibold text-dark dark:text-white">Our Address</h4>
                <p class="text-base text-body-color dark:text-dark-6">82 12th Street, Office 14,</p>
                <p class="text-base text-body-color dark:text-dark-6">Edinburgh, UK</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap -mx-4">
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[510px] text-center lg:mb-20">
              <span class="block mb-2 text-lg font-semibold text-primary"> Contact Us </span>
              <h2
            ...
            <div class="flex flex-wrap justify-center -mx-4">
              <div class="w-full px-4 md:w-1/2">
                <div class="mb-7 lg:mb-9">
                  <label class="block mb-3 text-base font-medium text-dark dark:text-white md:mb-5">
                    <span>Your Name</span> <span class="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
                    class="w-full rounded border border-stroke dark:border-dark-3 dark:bg-dark dark:text-dark-6 bg-white py-3 px-[14px] text-base leading-relaxed text-body-color outline-none focus:border-primary focus-visible:shadow-none md:py-4 md:px-[18px]"
                  />
                </div>
              </div>
              <div class="w-full px-4 md:w-1/2">
              ...
              <div class="w-full px-4">
                <div class="mb-7 lg:mb-9">
                  ...
                  <textarea
                    rows="4"
                    class="w-full resize-none rounded border border-stroke dark:border-dark-3 dark:bg-dark dark:text-dark-6 bg-white py-3 px-[14px] text-base leading-relaxed text-body-color outline-none focus:border-primary focus-visible:shadow-none md:py-4 md:px-[18px]"
                  ></textarea>
                </div>
              </div>
              <div class="w-full px-4">
                <label
                  ...
                  class="mb-12 flex cursor-pointer items-center text-base text-body-color md:mb-[70px]"
                >
                  <div class="relative">
                    <input type="checkbox" id="checkboxLabelTwo" class="sr-only" />
                    <div
                      class="flex items-center justify-center w-5 h-5 mr-4 bg-white border rounded box border-stroke dark:bg-dark dark:border-dark-3"
                    >
                      <span class="opacity-0 text-primary dark:text-white">
                        <svg
                          width="11"
                          height="8"
                          viewBox="0 0 11 8"
              ...
              <div class="w-full px-4 sm:w-8/12 lg:w-4/12">
                <div class="text-center">
                  <button
                    type="submit"
                    class="block w-full px-10 py-5 text-base font-medium text-center text-white transition rounded-md bg-primary hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
