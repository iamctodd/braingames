<template>
  ...
  <section class="relative z-40 overflow-hidden bg-white dark:bg-dark">
    <div class="container mx-auto">
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-8 lg:w-5/12 xl:w-4/12">
          <div class="relative z-10 flex flex-col justify-between py-20 pr-10 lg:text-right">
            <div class="mb-14 lg:mb-56">
              <h2 class="mb-4 text-4xl font-bold text-white sm:text-[40px]">Contact Info</h2>
              <p class="text-base text-white/90">
                Lorem ipsum dolor sit amet, consectetur. <br />
                In non dui aliquet, pellentesque
              </p>
            </div>
            <div>
              <div class="mb-14">
                <p class="text-xl text-white">
                  <span class="block"> info@yourmail.com </span>
                  <span class="block"> +24 968 0572 </span>
                  <span class="block"> Open from Mo. Till Fri. </span>
                  <span class="block"> 09.00 - 17.00 </span>
                </p>
              </div>
              <div>
                <p class="mb-3 text-xl font-medium text-white">Follow us on</p>
                <div class="flex items-center space-x-4 lg:justify-end">
                  <a href="javascript:void(0)" class="text-white/60 hover:text-white">
                    <svg viewBox="0 0 10 18" class="w-5 h-5 fill-current">
                      <path
                  ...
                  <a href="javascript:void(0)" class="text-white/60 hover:text-white">
                    <svg viewBox="0 0 19 15" class="w-5 h-5 fill-current">
                      <path
                  ...
                  <a href="javascript:void(0)" class="text-white/60 hover:text-white">
                    <svg viewBox="0 0 18 18" class="w-5 h-5 fill-current">
                      <path
            ...
            <div class="absolute top-0 right-0 -z-10 h-full w-[500%] bg-secondary"></div>
            <div>
              <span class="absolute -left-4 bottom-10 -z-10">
                <svg
                  width="77"
                  height="76"
                  viewBox="0 0 77 76"
        ...
        <div class="w-full px-8 lg:w-7/12 xl:w-8/12">
          <div class="py-20">
            <div class="mb-14 max-w-[420px]">
              <h2 class="mb-4 text-4xl font-bold text-dark dark:text-white sm:text-[45px]">
                Get in touch
              </h2>
              <p class="text-base text-body-color dark:text-dark-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. In non dui aliquet,
                pellentesque tellus ac, faucibus ex.
              </p>
            </div>
            <form>
              <div class="flex flex-wrap -mx-3">
                <div class="w-full px-3 md:w-1/2">
                  <div class="mb-7">
                    ...
                    <input
                      type="text"
                      class="w-full px-5 py-3 bg-transparent border rounded-md outline-none border-stroke dark:border-dark-3 text-body-color focus:border-primary focus-visible:shadow-none dark:text-dark-6"
                    />
                  </div>
                </div>
                <div class="w-full px-3 md:w-1/2">
                ...
                <div class="w-full px-3">
                  <div class="mb-8">
                    ...
                    <textarea
                      rows="5"
                      class="w-full px-5 py-3 bg-transparent border rounded-md outline-none resize-none border-stroke dark:border-dark-3 text-body-color focus:border-primary focus-visible:shadow-none dark:text-dark-6"
                    ></textarea>
                  </div>
                </div>
                <div class="w-full px-3">
                  <button
                    class="py-3 text-base font-medium text-white bg-black border border-transparent rounded-md px-7 hover:bg-opacity-90"
                  >
                    Send Message
                  </button>
                </div>
