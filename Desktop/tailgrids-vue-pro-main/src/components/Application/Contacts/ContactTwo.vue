<template>
  ...
  <section class="relative z-40 py-20 lg:py-[120px] dark:bg-dark bg-white">
    <div class="absolute top-0 left-0 z-[-1] h-1/2 w-full bg-[#E9F9FF] dark:bg-dark-3"></div>
      ...
      <div class="flex flex-wrap items-center -mx-4">
        <div class="w-full px-4 lg:w-6/12 xl:w-7/12">
          <div class="mb-[60px] lg:mb-[100px] xl:mb-[150px]">
            ...
            <h2 class="text-[35px] font-semibold leading-tight text-dark dark:text-white">
              Let’s talk about <br />
              your problem.
            </h2>
          </div>
            ...
            <div class="w-full max-w-[330px] px-4">
              <div class="w-full mb-12">
                <div class="flex">
                  ...
                  <div>
                    <h5 class="mb-4 text-lg font-medium text-dark dark:text-white">Our Location</h5>
            ...
            <div class="w-full max-w-[330px] px-4">
              <div class="w-full mb-12">
                <div class="flex">
                  ...
                  <div>
                    <h5 class="mb-4 text-lg font-medium text-dark dark:text-white">
                      How Can We Help?
                    </h5>
                    <p class="mb-2 text-base text-body-color dark:text-dark-6">
                      info@yourdomain.com
                    </p>
                    <p class="text-base text-body-color dark:text-dark-6">contact@yourdomain.com</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="w-full px-4 lg:w-6/12 xl:w-5/12">
          ...
          >
            <h3 class="mb-8 text-2xl font-semibold text-dark dark:text-white sm:text-[28px]">
              Send us a Message
            </h3>
            <form>
              <div class="mb-6">
                <label class="block text-xs text-body-color dark:text-dark-6"> Full Name* </label>
                <input
                  type="text"
                  placeholder="Adam Gelius"
                  class="text-body-color focus:border-primary w-full border-b border-[#f1f1f1] placeholder:opacity-30 dark:border-dark-3 dark:text-dark-6 bg-transparent py-4 text-base outline-none focus-visible:shadow-none"
                />
              </div>
              <div class="mb-6">
                <label class="block text-xs text-body-color dark:text-dark-6"> Email* </label>
                <input
                  type="email"
              ...
              <div class="mb-6">
                <label class="block text-xs text-body-color dark:text-dark-6"> Phone* </label>
                <input
                  type="text"
              ...
              <div class="mb-6">
                <label class="block text-xs text-body-color dark:text-dark-6"> Message* </label>
                <textarea
                  rows="1"
                  placeholder="Type your message here"
                  class="text-body-color focus:border-primary w-full resize-none border-b border-[#f1f1f1] placeholder:opacity-30 dark:border-dark-3 dark:text-dark-6 bg-transparent py-4 text-base outline-none focus-visible:shadow-none"
                ></textarea>
              </div>
              <div>
                <button
                  type="submit"
                  class="px-10 py-3 text-base font-medium text-white transition rounded bg-primary hover:bg-primary/90"
                >
                  Send Message
                </button>
              </div>
