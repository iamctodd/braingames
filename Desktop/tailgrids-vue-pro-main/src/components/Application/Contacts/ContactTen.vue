<template>
  ...
  <section class="py-24 overflow-hidden bg-white dark:bg-dark">
    <div class="container mx-auto">
      <div class="flex flex-wrap justify-center">
        <div class="w-full px-4 xl:w-10/12">
          <div class="flex flex-wrap px-5 mb-16 -mx-4 bg-primary py-14 sm:p-14">
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div class="flex mb-5 lg:mb-0">
                ...
                <div>
                  ...
                  <p class="text-base text-white/70">info@example.com</p>
                  <p class="text-base text-white/70">sales@yourmail.com</p>
                </div>
              </div>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
              <div class="flex mb-5 lg:mb-0">
                ...
                <div>
                  ...
                  <p class="text-base text-white/70">+09 098 2345 332</p>
                  <p class="text-base text-white/70">+77 904 5673 345</p>
                </div>
              </div>
            </div>
            <div class="w-full px-4 md:w-1/2 lg:w-1/3">
                ...
                <div class="w-full px-4 md:w-1/2">
                  <div class="mb-7">
                    <input
                      ...
                      class="w-full px-5 py-[17px] bg-transparent border outline-none border-stroke dark:border-dark-3 focus:border-primary text-body-color dark:text-dark-6"
                    />
                  </div>
                </div>
                <div class="w-full px-4 md:w-1/2">
                ...
                <div class="w-full px-4">
                  <div class="mb-7">
                    <textarea
                      ...
                      rows="6"
                      class="w-full px-5 py-[17px] bg-transparent border outline-none resize-none border-stroke dark:border-dark-3 focus:border-primary text-body-color dark:text-dark-6"
                    ></textarea>
                  </div>
                </div>
                <div class="w-full px-4">
                  <div>
                    <button
                      type="submit"
                      class="inline-flex items-center justify-center py-3 text-base font-medium text-white border border-transparent px-7 bg-primary hover:bg-opacity-90"
                    >
                      Submit Message
                    </button>
                  </div>
