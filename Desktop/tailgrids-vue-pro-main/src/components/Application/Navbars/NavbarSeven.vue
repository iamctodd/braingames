                ...
                <template v-for="(item, index) in navLinkItems" :key="index">
                  <li>
                    <a
                      v-if="item.href"
                      :href="item.href"
                      class="flex py-2 text-base font-medium text-white/70 hover:text-white lg:ml-12 lg:inline-flex lg:py-6"
                    >
                      {{ item.text }}
                    </a>
                  </li>
          ...
          <div class="justify-end hidden pr-16 sm:flex lg:pr-0">
            ...
            >
              <input
                ...
                class="w-full rounded border border-transparent bg-[#FCFDFE]/[.2] py-2.5 pr-5 pl-12 text-white placeholder-white placeholder-opacity-50 outline-none focus:border-opacity-100 focus-visible:shadow-none"
              />
