<template>
  ...
  <section class="flex items-center justify-center min-h-screen bg-white dark:bg-dark">
        ...
        <div class="w-full px-4">
          ...
          >
            ...
            <a
              ...
              class="inline-block px-8 py-3 text-base font-semibold text-center transition bg-white border border-white rounded-lg text-primary hover:bg-opacity-90"
            >
              Go To Home
            </a>
            <div>
