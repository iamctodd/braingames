...
<template>
  <div class="container mx-auto py-20">
    ...
    >
      <div
        ref="modalContainer"
        class="relative mx-auto w-full max-w-[445px] rounded-lg bg-white p-8 shadow-1 dark:shadow-3 dark:bg-dark-2"
      >
        <h3
          class="mb-6 border-b dark:border-dark-3 dark:text-white border-stroke pb-4 text-2xl font-semibold text-dark sm:text-[28px]"
        >
          Share Modal
        </h3>
        <p class="mb-[22px] text-lg font-medium text-dark dark:text-white">Share this link via</p>

        <div class="mb-7 flex items-center space-x-[18px]">
          <button
            class="flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#157BEE80] text-[#157BEE] hover:border-[#157BEE] hover:bg-[#157BEE] hover:text-white"
          >
            <svg width="12" height="21" viewBox="0 0 12 21" class="fill-current">
              <path
                d="M10.7197 8.01172H8.96043H8.33212V7.36656V5.36656V4.7214H8.96043H10.2799C10.6255 4.7214 10.9082 4.46333 10.9082 4.07624V0.65688C10.9082 0.302041 10.6569 0.0117188 10.2799 0.0117188H7.98654C5.50471 0.0117188 3.77685 1.81817 3.77685 4.49559V7.30204V7.9472H3.14854H1.01228C0.572465 7.9472 0.164062 8.30204 0.164062 8.81817V11.1408C0.164062 11.5924 0.509634 12.0117 1.01228 12.0117H3.08571H3.71402V12.6569V19.1408C3.71402 19.5924 4.0596 20.0117 4.56224 20.0117H7.51531C7.7038 20.0117 7.86088 19.9149 7.98654 19.7859C8.11221 19.6569 8.20645 19.4311 8.20645 19.2375V12.6891V12.044H8.86618H10.2799C10.6883 12.044 11.0024 11.7859 11.0653 11.3988V11.3666V11.3343L11.5051 9.10849C11.5365 8.88269 11.5051 8.62462 11.3166 8.36656C11.2538 8.20527 10.971 8.04398 10.7197 8.01172Z"
              />
            </svg>
          </button>
          <button
            class="flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#45C3F680] text-[#45C3F6] hover:border-[#45C3F6] hover:bg-[#45C3F6] hover:text-white"
          >
            <svg width="23" height="18" viewBox="0 0 23 18" class="fill-current">
              <path
                d="M19.624 3.54597L20.9658 1.98041C21.3542 1.55641 21.4601 1.23025 21.4955 1.06717C20.4361 1.65425 19.4474 1.84995 18.8119 1.84995H18.5647L18.4234 1.71949C17.576 1.03455 16.5167 0.675781 15.3868 0.675781C12.915 0.675781 10.973 2.5675 10.973 4.75275C10.973 4.88322 10.973 5.07891 11.0083 5.20937L11.1142 5.86169L10.3727 5.82907C5.85294 5.69861 2.14535 2.11088 1.54507 1.49118C0.556383 3.12196 1.12135 4.68752 1.72163 5.66599L2.92218 7.49248L1.01542 6.514C1.05073 7.88387 1.6157 8.96019 2.71032 9.74297L3.6637 10.3953L2.71032 10.7541C3.31059 12.4175 4.65239 13.1024 5.64108 13.3633L6.94757 13.6895L5.7117 14.4723C3.73432 15.7769 1.26259 15.679 0.167969 15.5812C2.39252 17.0163 5.0408 17.3424 6.87695 17.3424C8.25405 17.3424 9.27805 17.212 9.52523 17.1141C19.4121 14.9615 19.8712 6.80755 19.8712 5.17676V4.94845L20.083 4.81798C21.2836 3.77428 21.7779 3.21981 22.0604 2.89365C21.9545 2.92627 21.8132 2.9915 21.672 3.02412L19.624 3.54597Z"
              />
            </svg>
          </button>
          <button
            class="flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#CF437A80] text-[#CF437A] hover:border-[#CF437A] hover:bg-[#CF437A] hover:text-white"
          >
            <svg width="20" height="21" viewBox="0 0 20 21" class="fill-current">
              <path
                d="M9.83553 14.0119C11.8589 14.0119 13.4992 12.4064 13.4992 10.4259C13.4992 8.44536 11.8589 6.83984 9.83553 6.83984C7.81215 6.83984 6.17188 8.44536 6.17188 10.4259C6.17188 12.4064 7.81215 14.0119 9.83553 14.0119Z"
              />
              <path
                d="M13.8077 0.835938H5.78558C2.59568 0.835938 0.00585938 3.37088 0.00585938 6.4932V14.2835C0.00585938 17.4677 2.59568 20.0026 5.78558 20.0026H13.7445C16.9976 20.0026 19.5874 17.4677 19.5874 14.3453V6.4932C19.5874 3.37088 16.9976 0.835938 13.8077 0.835938ZM9.82822 15.1182C7.14365 15.1182 5.02758 12.9851 5.02758 10.4193C5.02758 7.85341 7.17524 5.72035 9.82822 5.72035C12.4496 5.72035 14.5973 7.85341 14.5973 10.4193C14.5973 12.9851 12.4812 15.1182 9.82822 15.1182ZM16.4607 6.15314C16.1449 6.4932 15.6711 6.67868 15.1342 6.67868C14.6604 6.67868 14.1867 6.4932 13.8077 6.15314C13.4603 5.81309 13.2708 5.38029 13.2708 4.85475C13.2708 4.32922 13.4603 3.92734 13.8077 3.55637C14.1551 3.1854 14.5973 2.99992 15.1342 2.99992C15.6079 2.99992 16.1133 3.1854 16.4607 3.52545C16.7765 3.92734 16.9976 4.39105 16.9976 4.88567C16.966 5.38029 16.7765 5.81309 16.4607 6.15314Z"
              />
              <path
                d="M15.1681 4.10938C14.7576 4.10938 14.4102 4.44943 14.4102 4.85131C14.4102 5.25319 14.7576 5.59325 15.1681 5.59325C15.5787 5.59325 15.9261 5.25319 15.9261 4.85131C15.9261 4.44943 15.6103 4.10938 15.1681 4.10938Z"
              />
            </svg>
          </button>
          <button
            class="flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#45BB5C80] text-[#45BB5C] hover:border-[#45BB5C] hover:bg-[#45BB5C] hover:text-white"
          >
            <svg
              width="24"
              height="24"
          ...
          <button
            class="flex h-[50px] w-[50px] items-center justify-center rounded-full border border-[#008CD080] text-[#008CD0] hover:border-[#008CD0] hover:bg-[#008CD0] hover:text-white"
          >
            <svg
              width="24"
              height="24"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_3075_775)">
                <path
        ...
        <p class="mb-4 text-lg font-medium text-dark dark:text-white">Or copy link</p>

        <form class="relative">
          <input
            type="text"
            value="example.com/share-link"
            class="h-12 w-full rounded border border-stroke pl-[46px] pr-[86px] text-base text-dark placeholder-body-color outline-none focus:border-primary bg-transparent dark:text-white dark:border-dark-3"
          />
          <span class="absolute -translate-y-1/2 text-dark dark:text-white top-1/2 left-4">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_2095_7720)">
                <path
          ...
          <button
            class="absolute right-[10px] top-1/2 h-[30px] -translate-y-1/2 rounded bg-primary px-5 text-sm font-medium text-white hover:bg-opacity-90"
          >
            Copy
          </button>
        </form>
