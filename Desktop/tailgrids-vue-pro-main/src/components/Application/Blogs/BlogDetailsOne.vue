...
const blogDetails = ref({
  ...
  view: '05',
  title: {
    one: 'Facing a challenge is kind of a turn-on for an easy rider',
    two: 'Sea no quidam vulputate',
    three: 'What is it with your ideas?'
  },
  author: {
    id: 1,
    name: 'Samuyl Joshi',
    avatar:
      'https://cdn.tailgrids.com/2.0/image/application/images/blog-details/blog-details-01/author-01.png'
  },
  content: {
    one: 'Consider this: almost 95% of shoppers read online reviews before making a purchase, and displaying reviews can increase conversion rates by up to 270%. With numbers such as these, it’s crystal-clear that customer reviews are an important part of every eCommerce store owner’s strategy.',
    two: 'There’s a time and place for everything… including asking for reviews. For instance: you should not asking for a review on your checkout page. The sole purpose of this page is to guide your customer to complete their purchase, and this means that the page should be as minimalist and pared-down possible. You don’t want to have any unnecessary elements or Call To Actions.',
    three:
    ...
    four: 'At quo cetero fastidii. Usu ex ornatus corpora sententiae, vocibus deleniti ut nec. Ut enim eripuit eligendi est, in iracundia signiferumque quo. Sed virtute suavitate suscipiantur ea, dolor this can eloquentiam ei pro. Suas adversarium interpretaris eu sit, eum viris impedit ne. Erant appareat corrumpit ei vel.',
  ...
  image: {
    one: 'https://cdn.tailgrids.com/2.0/image/application/images/blog-details/blog-details-01/image-01.jpg',
    two: 'https://cdn.tailgrids.com/2.0/image/application/images/blog-details/blog-details-01/image-02.jpg',
    three:
      'https://cdn.tailgrids.com/2.0/image/application/images/blog-details/blog-details-01/image-03.jpg'
  },
  ...
  commentItems: [
    {
      ...
      comments:
        'Eget ipsum elementum venenatis. Aenean maximus urna magna, quis rutrum mi semper non. Cras rhoncus elit non.'
    },
    {
      isReply: true,
  ...
  authorQuote: `A spring of truth shall flow from it: like a new star it shall scatter the darkness of ignorance, and cause a light heretofore unknown to shine amongst men.`,
  authorNameOfQuote: `Andrio Domeco`
})
</script>
        ...
        <div class="w-full px-4 lg:w-10/12 xl:w-8/12">
          <div class="w-full">
            ...
            <div class="flex flex-wrap items-center pb-4">
              <div class="flex items-center mb-4 mr-5 md:mr-10">
                <div class="w-10 h-10 mr-4 overflow-hidden rounded-full">
                  <img :src="blogDetails.author.avatar" alt="Author Avatar" class="w-full" />
                </div>
                <p class="text-base font-medium text-body-color dark:text-dark-6">
                  <span class="pr-0.5">By</span>
                  <a
                    :href="`/author/${blogDetails.author.id}`"
              ...
              <div class="flex items-center mb-4">
                ...
                >
                  ...
                  <span>{{ blogDetails.comment }}</span>
                </p>
                <p class="flex items-center text-sm font-medium text-body-color dark:text-dark-6">
                  <span class="mr-3">
                    <svg
                      width="16"
                      height="16"
            ...
            <p class="text-base leading-relaxed text-body-color dark:text-dark-6">
              {{ blogDetails.content.one }}
            </p>
            <div class="py-10 overflow-hidden rounded">
              <img :src="blogDetails.image.one" alt="image" class="w-full" />
            </div>
            <p class="mb-8 text-base leading-relaxed text-body-color dark:text-dark-6">
              {{ blogDetails.content.two }}
            </p>
            <p class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
              {{ blogDetails.content.three }}
            </p>
            <h3 class="mb-8 text-2xl font-bold text-dark dark:text-white sm:text-[26px]">
              {{ blogDetails.title.two }}
            </h3>
            <p class="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
              {{ blogDetails.content.four }}
            </p>

            <div
              class="relative z-10 mb-10 overflow-hidden rounded bg-primary p-10 text-center md:px-[60px]"
            >
              <div class="mx-auto max-w-[530px]">
                ...
                <p class="mb-4 text-base font-medium italic leading-[26px] text-white">
                  {{ blogDetails.authorQuote }}
                </p>
                <span class="text-sm italic text-white"> “{{blogDetails.authorNameOfQuote}}” </span>
              </div>
              <div>
                ...
                <span class="absolute bottom-0 left-0 -z-10">
                  <svg
                    width="49"
                    height="48"
                    viewBox="0 0 49 48"
            ...
            <h3 class="mb-8 text-2xl font-bold text-dark dark:text-white sm:text-[26px]">
              {{ blogDetails.title.three }}
            </h3>
            <div class="flex flex-wrap -mx-4">
              <div class="w-1/2 px-4">
                <div class="mb-8 overflow-hidden rounded">
                  <img :src="blogDetails.image.two" alt="image" class="w-full" />
                </div>
              </div>
              <div class="w-1/2 px-4">
                <div class="mb-8 overflow-hidden rounded">
                  <img :src="blogDetails.image.three" alt="image" class="w-full" />
                </div>
              </div>
            </div>
            <p class="text-base leading-relaxed mb-11 text-body-color dark:text-dark-6">
              {{ blogDetails.content.five }}
            </p>

            <div class="flex flex-wrap items-center mb-16 -mx-4 lg:mb-20">
              <div class="w-full px-4 md:w-1/2">
                <div
                  class="flex gap-2 md:gap-4 lg:gap-2 xl:gap-4 flex-wrap items-center mb-8 md:mb-0"
                >
                  <template v-for="(item, index) in blogDetails.tags" :key="index">
                    <a
                      href="javascript:void(0)"
                      class="block px-5 py-2 text-xs font-medium rounded bg-primary/5 text-primary hover:bg-primary hover:text-white"
                    >
                      {{ item }}
                    </a>
                  </template>
            ...
            <div class="flex mb-16">
              <div
                class="mr-5 h-20 w-full max-w-[80px] overflow-hidden rounded-full sm:mr-8 sm:h-[100px] sm:max-w-[100px]"
              >
                <img
                  src="https://cdn.tailgrids.com/2.0/image/application/images/blog-details/blog-details-01/author-02.png"
                  alt=""
                  class="w-full"
                />
              </div>
              <div class="w-full lg:mr-20">
                <span class="block text-xs font-medium text-body-color dark:text-dark-6">
                  Written By
                </span>
                <h4 class="mb-3 text-base font-semibold text-dark dark:text-white">
                  Melissa Hunter
                </h4>
                <p class="mb-5 text-base leading-relaxed text-body-color dark:text-dark-6">
                  Maecenas sit amet purus eget ipsum elementum venenatis. Aenean maximus urna magna,
                  quis rutrum mi semper non.
                </p>
                <div class="flex items-center">
                  <a href="javascript:void(0)" class="mr-6 text-dark-8 hover:text-primary">
            ...
            <div class="w-full">
              <h3 class="mb-12 text-[28px] font-bold text-dark dark:text-white">4 Comments</h3>

              <template v-for="(item, index) in blogDetails.commentItems" :key="index">
                <div :class="{ 'ml-16 flex pb-11 md:ml-[110px]': item.isReply, 'flex pb-11 lg:mr-16 xl:mr-[80px]': !item.isReply }">
                  <div
                    class="mr-5 h-14 w-full max-w-[56px] overflow-hidden rounded-full sm:mr-8 sm:h-20 sm:max-w-[80px]"
                  >
                    <img
                      :src="item.authorImg"
                      alt="image"
                  ...
                  <div class="w-full">
                    <h4 class="text-base font-semibold text-dark dark:text-white">{{ item.authorName }}</h4>
                    <span class="inline-block mb-3 text-xs text-body-color dark:text-dark-6">
                      {{ item.commentDate }}
                    </span>
                    ...
                    <button
                      class="px-5 py-2 text-xs font-medium rounded bg-primary/5 text-primary hover:bg-primary hover:text-white"
                    >
                      Reply
                    </button>
                  </div>
            ...
            <div class="w-full pt-9">
              <h3 class="mb-10 text-[28px] font-bold text-dark dark:text-white">Leave a comment</h3>
              <form>
                <div class="flex flex-wrap -mx-4">
                  <div class="w-full px-4 md:w-1/2">
                    <div class="mb-9">
                      <label class="block mb-4 text-base text-body-color dark:text-dark-6">
                        Your Name <span class="text-red">*</span>
                      </label>
                      <input
                        type="text"
                        class="w-full rounded border border-stroke dark:border-dark-3 dark:bg-dark bg-white py-3 px-[14px] text-body-color outline-none dark:text-dark-6 focus:border-primary"
                      />
                    </div>
                  </div>
                  <div class="w-full px-4 md:w-1/2">
                  ...
                  <div class="w-full px-4">
                    <div class="mb-12">
                      <label class="block mb-4 text-base text-body-color dark:text-dark-6">
                        Comment <span class="text-red">*</span>
                      </label>
                      <textarea
                        rows="7"
                        class="w-full resize-none rounded border border-stroke dark:border-dark-3 dark:bg-dark bg-white py-3 px-[14px] text-body-color outline-none dark:text-dark-6 focus:border-primary"
                      ></textarea>
                    </div>
                  </div>
                  <div class="w-full px-4">
                    <button
                      class="py-3 text-base font-semibold text-white rounded-md bg-primary px-11"
                    >
                      Submit
                    </button>
                  </div>
