...
<template>
  <section class="bg-gray-2 dark:bg-dark py-20 lg:py-[120px]">
    <div class="mx-auto px-4 md:container">
      <div
        class="flex items-center px-6 py-3 mb-5 bg-white border rounded-md dark:bg-dark-2 dark:border-dark-3 border-stroke"
      >
        <div class="relative inline-block">
          <select
            name=""
            id=""
            class="pr-12 text-base bg-transparent border-r outline-none appearance-none dark:text-dark-6 border-stroke dark:border-dark-3 text-body-color"
          >
            <option value="All Category" class="dark:bg-dark-2">All Category</option>
            <option value="Bootstrap" class="dark:bg-dark-2">Bootstrap</option>
          </select>
        ...
        <div class="relative">
          <input
            ...
            class="block w-full text-base bg-transparent outline-none dark:text-dark-6 pl-11 text-body-color"
          />
      ...
      <div class="bg-white border rounded-md dark:bg-dark-2 dark:border-dark-3 border-stroke">
          ...
          <table class="w-full table-auto">
            <thead>
              <tr>
                <th
                  ...
                  :key="index"
                  class="px-5 py-3 border border-stroke !border-t-transparent !border-l-transparent dark:border-dark-3"
                >
                  <div :class="`flex items-center justify-between ${header.styles}`">
                    <span class="text-sm dark:text-dark-6 text-body-color">
                      {{ header.name }}
                    </span>
                    <span v-if="header.icon" class="cursor-pointer">
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 14 14"
            ...
            <tbody>
              <tr v-for="(user, index) in users" :key="index">
                <td class="px-5 py-3 border border-stroke !border-l-transparent dark:border-dark-3">
                  <div class="relative">
                    <input
                      type="checkbox"
                      :id="'checkbox-' + index"
                    ...
                    >
                      <span
                        class="icon-box mr-3 flex h-4 w-4 items-center justify-center rounded-[3px] border-[.5px] border-stroke bg-gray-2 text-white dark:border-dark-3 dark:bg-dark"
                      >
                        <svg width="10" height="10" viewBox="0 0 10 10" class="opacity-0 icon">
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                ...
                <td class="px-5 py-3 border border-stroke dark:border-dark-3">
                  <p class="text-base text-body-color dark:text-dark-6">{{ user.products }}</p>
                </td>
                <td class="px-5 py-3 border border-stroke dark:border-dark-3">
                  <p class="text-base text-body-color dark:text-dark-6">{{ user.quantity }}</p>
                </td>
                <td class="px-5 py-3 border border-stroke dark:border-dark-3">
                  <p class="text-base text-right text-body-color dark:text-dark-6">
                    {{ user.price }}
                  </p>
                </td>
                <td class="px-5 py-3 border border-stroke !border-r-transparent dark:border-dark-3">
                  <div class="flex items-center justify-between">
                    <div
                      class="relative mr-8 block h-[5px] w-full max-w-[280px] rounded bg-stroke dark:bg-dark-4"
                    >
                      <div
                        :class="`absolute top-0 left-0 block h-full rounded bg-primary ${user.popularity}`"
                      ></div>
                    </div>
                    <div class="flex items-center justify-end space-x-3">
                      <button class="group text-body-color hover:text-yellow-dark">
                        <svg
                          width="16"
                          height="16"
                          viewBox="0 0 16 16"
                        ...
                        >
                          <path
                            ...
                            strokeWidth="1"
                            class="fill-transparent stroke-current group-hover:fill-current"
                          />
                        </svg>
                      </button>
                      <button class="hover:text-red-dark text-body-color">
                        <svg
                          width="16"
                          height="16"
                          viewBox="0 0 16 16"
        ...
        <div class="items-center justify-between p-5 sm:flex sm:px-6">
          <p
            class="mb-4 text-base font-medium text-right text-body-color dark:text-dark-6 sm:mb-0 sm:text-left md:text-lg"
          >
            Total Payable: 409
          </p>
          <div class="flex items-center justify-end">
            <button
              class="mr-3 py-[10px] text-base font-medium text-body-color dark:text-dark-6 hover:text-primary sm:mr-5"
            >
              Cancel Order
            </button>
            <button
              class="py-3 text-base font-medium text-white border border-transparent rounded-md bg-primary hover:bg-opacity-90 px-7 sm:text-base"
            >
              Complete Order
            </button>
          </div>
